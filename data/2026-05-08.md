...
TL;DR: Using the latest NANOGrav data, the paper constrains inflationary gravitational wave background parameters and finds evidence favoring a blue-tilted tensor spectrum and alpha-vacua initial state, proposes a frequency-dependent vacuum parameter to address spectral issues, and discusses implications for reheating and future GW observations.


<details>
  <summary>Details</summary>
Motivation: To investigate the origin of the common red noise signal observed by NANOGrav as evidence for a stochastic gravitational wave background and explore its inflationary implications including reheating phase and nature of primordial vacua.

Method: Analyze the NANOGrav 15-year dataset under the assumption of an inflationary SGWB origin; constrain inflationary parameters such as tensor spectral index and tensor-to-scalar ratio; examine modifications of the GW spectrum from non-Bunch-Davies vacua including alpha-vacua; use parameter estimation to narrow down characteristics of the vacua and test frequency dependence in the vacuum parameter alpha.

Result: Determined a preference for a blue-tilted tensor spectrum and radiation-like reheating equation of state; found observational support favoring the alpha-vacuum as the primordial state; constrained the vacuum parameter alpha tightly and proposed a frequency-dependent model of alpha to resolve the blue tilt issue; pointed out prospects for future GW experiments to test these features.

Conclusion: The NANOGrav data supports an inflationary origin of the SGWB characterized by a blue-tilted tensor spectrum and alpha-vacuum initial conditions, with reheating parameters consistent with radiation dominance; frequency-dependent vacuum parameters provide a natural solution to tensions in the spectral tilt and offer testable predictions for upcoming gravitational wave detectors.
...
TL;DR: This paper incorporates primordial magnetic fields into a fast analytic model to assess their effect on early universe structure and 21-cm signals, predicting that future 21-cm experiments combined with CMB data can effectively detect and constrain these fields through their influence on small-scale matter fluctuations.


<details>
  <summary>Details</summary>
Motivation: To understand how primordial magnetic fields (PMFs) influence early cosmic structure formation and their observable signatures in 21-cm signals during Cosmic Dawn.

Method: Extension of the fast analytic framework zeus21 to incorporate a physically motivated PMF contribution to the linear matter power spectrum, including effects like radiative damping before recombination and magnetic-pressure suppression below the magnetic Jeans scale, allowing efficient exploration of PMF parameter space.

Result: Quantification of PMF impact on early structure formation and 21-cm observables for spectral index n_B=-2.9 across various magnetic amplitudes; forecasts show that 21-cm experiments like HERA and SKA, combined with CMB priors, can detect and constrain PMFs through their effect on small-scale structure.

Conclusion: Upcoming 21-cm observations, supplemented by CMB data, offer a powerful and complementary avenue to constrain primordial magnetic fields via their imprints on early small-scale cosmic structures and corresponding 21-cm signals.
...
TL;DR: The study uses isolated low-surface-brightness galaxies and proto-clusters to estimate dark matter self-interaction effects on core formation, excluding high interaction cross sections and supporting a smaller value consistent with cluster core observations.


<details>
  <summary>Details</summary>
Motivation: Clarify the role of dark matter self-interactions in galaxy formation, specifically to distinguish their effects from baryonic processes on core structures in galaxies.

Method: Use order-of-magnitude estimates, assuming low-surface-brightness galaxies in the field decoupled from proto-clusters at high redshift, to set initial conditions and estimate core formation times, comparing these to the redshift times of proto-clusters without relying on numerical simulations.

Result: Excluded a self-interaction cross section of sigma/m = 1 cm^2/g, favoring sigma/m = 0.1 cm^2/g for dark matter, consistent with constraints from shapes of present-day cluster cores.

Conclusion: Dark matter self-interactions with cross sections around 0.1 cm^2/g likely contribute to core formation in isolated low-surface-brightness galaxies, while larger cross sections (1 cm^2/g) are inconsistent with observed galaxy and proto-cluster properties.
...
TL;DR: This study compares different models explaining pulsar-timing-array gravitational-wave data and finds that while ultralight-dark-matter effects are compatible with observations, current data do not decisively prefer these models over others.


<details>
  <summary>Details</summary>
Motivation: To investigate the effects of ultralight-dark-matter solitons on the gravitational-wave background and to differentiate between various models explaining pulsar-timing-array data related to supermassive black-hole binaries.

Method: Comparison of four models—simplified and realistic ultralight-dark-matter implementations, a phenomenological environmental-hardening model, and a gravitational-wave-only model—using Bayesian leave-one-out cross-validation on the five lowest pulsar-timing-array frequency bins.

Result: The phenomenological environmental-hardening model shows the highest expected log predictive density, though its advantage over other models is not statistically significant. Among ultralight-dark-matter models, the simplified model consistently outperforms the realistic one. Overall, current data do not decisively favor any single model but are compatible with ultralight-dark-matter influence on low-frequency suppression.

Conclusion: Current pulsar-timing-array gravitational-wave data are consistent with ultralight-dark-matter effects but do not yet provide significant evidence to distinguish ultralight-dark-matter models from more general environmental models of supermassive-black-hole-binary evolution.
...
TL;DR: By reformulating the Hubble tension via the dimensionless expansion history E(z), the study finds that discrepancies between Planck, DESI DR2, and Pantheon+SH0ES data are moderate and less significant than the standard scalar H_0 tension suggests.


<details>
  <summary>Details</summary>
Motivation: To address the discrepancies in Hubble constant (H_0) measurements expressed as the Hubble tension between early universe (Planck CMB) and late-time (distance-ladder) observations within the ΛCDM cosmological model.

Method: They reformulate the comparison of H_0 measurements in terms of the dimensionless expansion history E(z)=H(z)/H_0, separating the absolute scale normalization from the redshift-dependent shape. Posterior distributions from Planck CMB, DESI DR2 BAO, Pantheon+SH0ES are mapped onto expansion histories and compared using a covariance-subspace history displacement metric (S_hist) and pointwise redshift differences.

Result: The discrepancies in E(z) histories across probes are moderate, with pointwise significance typically 1-2σ and global mismatch S_hist statistics of ~1.65 for DESI DR2 and ~2.55 for Pantheon+SH0ES relative to Planck. These correspond to 1.1σ and 2.1σ Gaussian equivalents, substantially lower than the conventional ~4.9σ H_0 tension scalar discrepancy.

Conclusion: Expressing the Hubble tension in terms of the expansion history E(z) reduces the significance of the discrepancies between early- and late-time cosmological probes relative to the common base ΛCDM model. This suggests that the conventional scalar H_0 tension overestimates the true mismatch when the full expansion history covariance is considered.
...
TL;DR: The paper proposes a novel method to detect axion-like particle dark matter by cross-correlating radio intensity maps with galaxy distributions, developing a theoretical framework that includes stimulated decay effects, and demonstrating promising detection prospects using SKA Phase 2.


<details>
  <summary>Details</summary>
Motivation: The nature of dark matter remains unknown, with axion-like particles (ALPs) as potential candidates. Detecting ALP dark matter through their radiative decay into photons, especially enhanced by ambient radiation, presents a novel observational challenge.

Method: The paper proposes cross-correlating radio intensity mapping with the large-scale galaxy distribution from the 2MASS Redshift Survey within the local universe. It develops a theoretical framework including stimulated decay effects influenced by the CMB and an extragalactic radio background model. Sensitivity forecasts for SKA Phase 2 are made to evaluate detection prospects.

Result: The cross-correlation approach is shown to be a promising and complementary method to detect μeV-scale ALP dark matter signals. It provides a new observational probe leveraging next-generation radio telescopes on cosmic scales.

Conclusion: This study establishes a proof-of-concept that cross-correlating radio intensity mapping with galaxy surveys can effectively probe ALP dark matter, enhancing search strategies with future instruments like the SKA Phase 2.
...
TL;DR: This paper tests whether the speed of light is constant by combining galaxy cluster X-ray and supernova data, finding results consistent with constancy except for mild tension under Planck-based cluster calibration.


<details>
  <summary>Details</summary>
Motivation: To use improved galaxy cluster observations and complementary cosmological data to test the fundamental physics assumption that the speed of light is constant across cosmological scales.

Method: Combine X-ray gas mass fraction measurements from galaxy clusters with SNe Ia luminosity distances from Pantheon+ dataset, adopting SH0ES prior on H_0 and Ω_b/Ω_m ratio from galaxy clustering to minimize cosmological model dependence; test different cluster mass calibration methods (CLASH, CCCP, Planck) to evaluate their impact on the constancy of c.

Result: No deviation from constant speed of light was found when using CLASH or CCCP mass calibrations; however, Planck-based calibration showed mild tension at about 2σ level, suggesting sensitivity of results to calibration choice.

Conclusion: The speed of light, c, is consistent with being constant based on the combined analysis of galaxy cluster X-ray gas mass fraction data and SNe Ia luminosity distances, except for a mild tension when using Planck-based cluster mass calibration, which indicates sensitivity to the calibration scheme.
...
### [8] [Constraining Galaxy Cluster Triaxiality via Weak Lensing -- I. Preparation for the Rubin Data Beyond Leading Order](https://arxiv.org/abs/2605.06587)
...
TL;DR: This paper measures the projected shapes of galaxy clusters from weak lensing data using triaxial modeling and stacking methods on Dark Energy Survey data, finding an ellipticity around 0.31 with no strong dependence on mass or redshift, validated by mock catalogs, and demonstrates applicability to future large cosmic surveys.


<details>
  <summary>Details</summary>
Motivation: Galaxy clusters have triaxial 3D mass distributions that are challenging to constrain from projected observations.

Method: The study measures the projected halo shapes of galaxy clusters from weak lensing data using the triaxiality functionality in the Cluster Lensing Mass Modeling software. It uses axis-aligned stacking and multipole expansion of weak lensing data from the Dark Energy Survey Year 3 data, selecting clusters with high central galaxy centering probability and determining major-axis orientations from satellite galaxy distributions. Analysis extends to second order ellipticity in monopole and quadrupole moments.

Result: The projected ellipticity of the cluster sample is measured as 0.310^{+0.017}_{-0.016} with an axis ratio of 0.527^{+0.018}_{-0.019}. The ellipticity does not show significant dependence on mass or redshift. Validation using mock catalogs confirms measurement accuracy.

Conclusion: Projected ellipticities of galaxy clusters can be robustly measured from weak lensing data using triaxial modeling and axis-aligned stacking methods. The approach is applicable to forthcoming large cosmic surveys to achieve tighter constraints on cluster shapes.
...
### [9] [On the Origin of Mass Ejection in Failed Supernovae](https://arxiv.org/abs/2605.05289)
*Daniel A. Paradiso,Sarah Vallejo,Eric R. Coughlin*

Main category: astro-ph.HE

TL;DR: Neutrino-driven weak shockwaves in failed supernovae show that stability and strength depend on the relative neutrino mass loss and stellar density gradient, with larger mass loss causing stronger, more luminous explosions especially in red supergiants.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamics and stability of weak shockwaves generated by neutrino emission in failed supernovae and their role in the transient signals and material ejection during black hole formation.

Method: Analyzing two self-similar shockwave propagation solutions considering Mach number stability, growth behavior over time, and dependence on mass loss and stellar density gradients.

Result: Larger Mach number solutions are unstable with shock Mach number growing slowly over time, while smaller Mach number solutions are stable; above a critical relative mass loss, the shock strengthens and approaches a strong shock limit.

Conclusion: The relative mass loss to neutrinos compared to the enclosed mass and the local stellar density gradient primarily control shock strength and ejected material, explaining why red supergiants produce more luminous explosions and eject more material than compact progenitors.
...
### [10] [No model-independent evidence for a peak in binary black hole spin (mis)alignments](https://arxiv.org/abs/2605.05300)
*Noah E. Wolfe,Salvatore Vitale,Michael Zevin*

Main category: astro-ph.HE

TL;DR: This study examined black hole spin tilts in gravitational-wave data to probe binary formation origins, finding no significant tilt pattern linked to mass but confirming that spin magnitude correlates with mass, thus refining understanding of black hole populations.


<details>
  <summary>Details</summary>
Motivation: To determine whether the distribution of black-hole spin-orbit misalignment angles ('tilts') can reveal the formation channels of binary black holes by analyzing gravitational-wave data, addressing challenges caused by model inaccuracies and limited constraints from individual events.

Method: Analyzed the fourth LIGO-Virgo-KAGRA gravitational-wave transient catalog, testing for statistically significant peaks in spin tilt distributions across different black hole masses, and additionally examined spin magnitude and tilt distributions at fixed mass scales to identify correlations.

Result: Found no statistically significant or model-independent peak in the spin tilt distribution, indicating no reliable subpopulations based on spin tilt; confirmed a confident correlation between spin magnitude and black hole mass, but no confident correlation between mass and spin tilt.

Conclusion: Spin tilt measurements from current gravitational-wave data do not provide a robust basis for distinguishing black hole binary formation channels, but the observed correlation between spin magnitude and mass supports previous findings and may aid future population studies.
...
### [11] [An X-ray and optical spectral study of the changing-look narrow-line Seyfert 1 2MASX J0413-0050](https://arxiv.org/abs/2605.05301)
...
TL;DR: The paper studies AGN 2MASX J0413-0050 which showed unusual spectral and flux variability over nearly two decades, concluding that its changing-look behavior is due to accretion state changes rather than obscuration, confirming that narrow-line Seyfert 1s can undergo such transitions.


<details>
  <summary>Details</summary>
Motivation: To investigate the nature of dramatic spectral and flux variations in active galactic nuclei (AGN), particularly focusing on the peculiar behavior of source 2MASX J0413-0050 which challenges typical changing-look AGN classifications.

Method: Multi-epoch optical and X-ray spectral observations conducted between 2004 and 2023 were analyzed, tracking changes in spectral type, emission lines (especially Hbeta), and X-ray flux to characterize the AGN's behavior.

Result: The source exhibited transitions in spectral type from narrow-line Seyfert 1 to Seyfert 1.9 and 1.8, disappearance and re-emergence of the Hbeta emission line, and variable X-ray flux. Evidence suggested multiple on/off accretion phases rather than changes in line-of-sight obscuration.

Conclusion: 2MASX J0413-0050 is best classified as a changing-state AGN, supporting that narrow-line Seyfert 1 galaxies can experience changing-look phenomena driven by accretion rate variations rather than obscuration changes.
...
### [12] [Multi-wavelength outburst activity from EP J174942.2-384834: a very faint X-ray transient discovered by Einstein Probe](https://arxiv.org/abs/2605.05303)
...
TL;DR: The Einstein Probe discovered a faint Galactic X-ray transient, EP J174942.2$-$384834, showing thermal Comptonization dominated X-ray outbursts, correlated optical/UV brightening, and no radio jets, indicating a very faint black hole transient.


<details>
  <summary>Details</summary>
Motivation: To discover and characterize faint Galactic X-ray transients and understand their nature and emission mechanisms.

Method: Detection by Einstein Probe of an X-ray outburst followed by coordinated multi-wavelength (X-ray, optical/UV, radio) follow-up observations and broadband spectral modeling.

Result: Two major outbursts and a rebrightening were observed over seven months. The X-ray emission showed thermal Comptonization of soft seed photons, with a cool/truncated accretion disk and consistently hard X-ray spectra that softened with declining flux. Optical/UV emission correlated with X-rays, dominated by disk viscous heating and possible irradiation. No significant radio jet detected.

Conclusion: EP J174942.2$-$384834 is classified as a very faint X-ray transient black hole candidate, demonstrating the Einstein Probe's capability to detect and characterize faint accreting compact objects in the Galaxy.
...
### [13] [Moving-mesh simulations of spreading dynamics and local electron cooling in structured gamma-ray burst afterglow jets](https://arxiv.org/abs/2605.05320)
*Sayan Kundu,Hendrik van Eerten*

Main category: astro-ph.HE

TL;DR: This paper uses relativistic hydrodynamic simulations with local electron cooling to study structured gamma-ray burst jets, finding significant effects on jet spreading and afterglow spectral features, particularly in the synchrotron cooling break and jet break behavior.


<details>
  <summary>Details</summary>
Motivation: To investigate the dynamics and emission profiles of structured gamma-ray burst afterglow jets using detailed numerical simulations.

Method: Axi-symmetric numerical simulations of gamma-ray burst afterglow jets were performed using the relativistic moving-mesh hydrodynamics code GAMMA, incorporating a local cooling approach to model electron populations and synchrotron emission.

Result: Jet spreading is moderately influenced by the initial angular structure steepness but becomes negligible once the jet front expands; the sound wave crossing time effectively predicts spreading onset. Local cooling significantly shifts the synchrotron cooling break frequency upward and smooths its spectral transition compared to global cooling models. Jet breaks become sharper with frequency, with local cooling producing a steeper post-break slope. Emission under local cooling originates from narrow, frequency-dependent regions behind the shock front, contrasting global cooling results.

Conclusion: The study demonstrates that detailed modeling of local electron cooling markedly alters the predicted afterglow spectra and jet dynamics compared to global cooling assumptions, providing improved insight into the interpretation of gamma-ray burst afterglow observations.
...
### [14] [Astrophysical X-Ray Polarization](https://arxiv.org/abs/2605.05355)
*Philip Kaaret,Brian D. Ramsey*

Main category: astro-ph.HE

TL;DR: This paper reviews how polarized X-rays are generated and measured in astrophysics, highlighting the role of new observables and developing detectors in advancing the study of high-energy cosmic environments.


<details>
  <summary>Details</summary>
Motivation: To introduce X-ray polarimetry as a novel observational tool in high-energy astrophysics, providing new insights into accretion flows and magnetic fields.

Method: Review of physical processes generating polarized X-rays and a summary of measurement techniques and detector technology for X-ray polarization.

Result: Identification of how polarization fraction and angle provide critical information about astrophysical systems, alongside an overview of instrumentation developed or under development for X-ray polarimetry.

Conclusion: X-ray polarimetry offers complementary observables that deepen understanding of high-energy astrophysical phenomena, supported by ongoing advancements in detection technology.
...
### [15] [Searches for Binary Mergers with Sub-solar Mass Components in Data from the First Part of LIGO--Virgo--KAGRA's Fourth Observing Run](https://arxiv.org/abs/2605.05444)
...
TL;DR: This paper reports a gravitational wave search for sub-solar mass compact binary mergers using LIGO data, finding no candidates but setting stringent upper limits on merger rates, thereby constraining models of primordial and dissipative dark matter black holes.


<details>
  <summary>Details</summary>
Motivation: To detect or constrain the existence and merger rates of sub-solar mass compact objects, which could provide insight into new astrophysical or dark matter phenomena such as primordial black holes or dissipative dark matter forming dark black holes.

Method: Search for gravitational waves from compact binary coalescences with at least one component mass between 0.2 and 1 solar masses using LIGO data collected from May 24, 2023, to January 16, 2024, applying established search algorithms to identify sub-solar mass candidates and quantify detection sensitivity and upper limits on merger rates.

Result: No sub-solar mass gravitational wave signals were found; the study established upper limits on merger rates of sub-solar mass black holes (110 to 10,000 Gpc^{-3}yr^{-1}) and on sub-solar mass neutron star binaries (~86 Gpc^{-3}yr^{-1}), which in turn place limiting constraints on primordial black hole dark matter fractions and parameter space of dissipative dark matter models.

Conclusion: No statistically significant gravitational wave candidates involving sub-solar mass compact objects were detected in LIGO data from May 2023 to January 2024, leading to new upper limits on merger rates of sub-solar mass black holes and neutron stars, which further constrain dark matter models involving primordial and dark black holes.
...
### [16] [A Multiwavelength Assessment Disfavoring the X-ray Binary Origin of He III Regions in Metal-Poor Star-Forming Dwarf Galaxies](https://arxiv.org/abs/2605.05548)
...
TL;DR: This study shows that accreting X-ray sources cannot fully explain the extreme-ultraviolet radiation needed for He II emission in metal-poor star-forming galaxies, implying other unknown sources contribute to the hard ionizing radiation.


<details>
  <summary>Details</summary>
Motivation: To understand the origin of the hard extreme-ultraviolet (EUV) radiation responsible for He III regions in metal-poor, star-forming dwarf galaxies, since standard stellar populations cannot explain the observed nebular He II emission, which is crucial for early galaxy formation models.

Method: A systematic Chandra X-ray study of 21 nearby star-forming galaxies with He II emission but no Wolf-Rayet signatures was conducted, involving 7 new and 36 archival X-ray observations and optical stellar population synthesis modeling to constrain ionizing continua and host H II region properties.

Result: The inferred EUV output from accreting X-ray sources is lower than required to produce the observed He II emission, and the X-ray luminosities follow established scaling relations, indicating that this discrepancy is not due to fewer or dimmer X-ray sources; thus, accreting X-ray sources cannot alone explain the He II-ionizing photon budget.

Conclusion: Accreting X-ray sources are insufficient to account for the hard EUV radiation producing He III regions in metal-poor, star-forming galaxies, suggesting the need for additional or alternative sources of hard EUV radiation in these environments.
...
### [17] [A comparative study of occurrence rates and nature of Ultraluminous X-ray sources in spiral and elliptical galaxies](https://arxiv.org/abs/2605.06133)
*C. M. Sariga,P. Shalima,D. Bhattacharya,Vivek K. Agrawal*

Main category: astro-ph.HE

TL;DR: This study reveals that ULXs in galaxies with a single source differ in spectral properties and associations compared to those in galaxies with multiple sources, with distinctions also linked to host morphology. These findings hint at multiple ULX populations influenced by galaxy type and ULX occurrence rate.


<details>
  <summary>Details</summary>
Motivation: To identify possible differences in properties of ultraluminous X-ray sources (ULXs) between galaxies with a single ULX and those with multiple ULXs, particularly focusing on host galaxy morphology (spiral versus elliptical).

Method: The study generates flux-limited, credible samples of ULXs categorized by their occurrence rate per galaxy (single ULX vs. multiple ULXs) in spiral and elliptical galaxies, then compares their spectral properties and associations.

Result: A distinct population of ULXs was identified in spiral galaxies with a single ULX, showing a reasonable mix of soft and hard sources, whereas galaxies with multiple ULXs predominantly contained harder sources. Additionally, six ULXs in single-ULX elliptical galaxies were found to be associated with globular clusters. Some luminous candidates likely host massive accretors.

Conclusion: There is a potential link between ULX types, their occurrence rates, and host galaxy morphology. This suggests different underlying populations or formation mechanisms depending on the host environment and frequency of ULXs, which requires further observational validation and spectral analysis.
...
### [18] [Vacuum polarization and cyclotron resonance effects on radiative transfer and plasma deceleration in subcritical X-ray pulsars](https://arxiv.org/abs/2605.06162)
*I. D. Markozov,A. Y. Potekhin,A. D. Kaminker,A. A. Mushtukov*

Main category: astro-ph.HE

TL;DR: Simulations of subcritical X-ray pulsars reveal that vacuum polarization enhances cyclotron spectral features, alters polarization behavior, and that cyclotron line energy increases with accretion luminosity, matching observations.


<details>
  <summary>Details</summary>
Motivation: To understand the spectrum and polarization characteristics of radiation from subcritical X-ray pulsars, particularly exploring how resonant Compton scattering and vacuum polarization influence the radiation and plasma behavior in strong magnetic fields.

Method: Conducting self-consistent radiation-hydrodynamic simulations of an accretion channel in a strong magnetic field with polarized radiative transfer for two normal modes, including effects of resonant Compton scattering and vacuum polarization.

Result: The simulations show that resonant scattering governs the deceleration of accreting matter in the subcritical regime, vacuum polarization dominates plasma birefringence enhancing cyclotron features and radiative deceleration, linear polarization degree exhibits a sign change above cyclotron resonance, and the cyclotron line centroid energy positively correlates with accretion luminosity.

Conclusion: Vacuum polarization critically impacts the polarization properties and radiative deceleration in subcritical X-ray pulsars, confirming theoretical predictions and explaining observed positive correlations of cyclotron feature energy with luminosity.
...
### [19] [Gravitational Lensing of Gravitational Waves from Astrophysical Sources: Theory, Detection, and Applications](https://arxiv.org/abs/2605.06321)
*Zhiwei Chen,Youjun Lu*

Main category: astro-ph.HE

TL;DR: This review summarizes how gravitational waves from various compact binaries can be lensed by astrophysical objects, outlining lensing effects, detection methods, expected rates, and the valuable insights lensed GWs provide for physics and cosmology.


<details>
  <summary>Details</summary>
Motivation: The paper aims to address the significance and characteristics of gravitational wave (GW) lensing by various astrophysical objects and its implications for fundamental physics and cosmology.

Method: A comprehensive review approach summarizing the theoretical framework of GW lensing, expected detection rates, observational search strategies, and potential applications.

Result: The review identifies distinctive lensing regimes (geometric and wave optics), summarizes detection prospects based on source and lens distributions, and emphasizes how confirmed lensed GWs can constrain dark matter, cosmological parameters, and astrophysical structures.

Conclusion: Gravitational wave lensing offers unique opportunities to study astrophysical lenses and fundamental physics with upcoming observations; the field holds promising directions for future research and practical exploitation of lensed GW signals.
