...
### [12] [Ultra-High-Energy Particle Production in Binary Mergers Endowed with Magnetic Fields](https://arxiv.org/abs/2607.21385)
...
### [13] [Importance and Science Outcomes from the first XSPECT/XPoSat Workshop](https://arxiv.org/abs/2607.21365)
...
### [15] [Isotropic deceleration and near-zero baseline acceleration in Pantheon+ supernovae: new arguments in the dark energy debate](https://arxiv.org/abs/2607.20570)
...
### [16] [Gravitational Lensing Predictions from Wave Simulations of Fuzzy Dark Matter](https://arxiv.org/abs/2607.20614)
...
### [17] [What could an emerging Big Bang Nucleosynthesis discrepancy be hinting at?](https://arxiv.org/abs/2607.20635)
...
### [18] [The correlation between voids identified in 3D large-scale-structure and 2D weak-lensing maps](https://arxiv.org/abs/2607.20637)
...
### [19] [When galaxies burst II. Implications of enhanced burstiness for the 21-cm Cosmic Dawn signal](https://arxiv.org/abs/2607.20651)
...
### [20] [Probing the baryonic--dark matter connection in galaxy clusters using X-rays with gated recurrent unit neural networks](https://arxiv.org/abs/2607.20721)
...
### [21] [A Multimodal Approach to Star--Galaxy Separation using SPHEREx Spectrophotometry and DESI Legacy Survey Imaging](https://arxiv.org/abs/2607.20797)
...
### [22] [A lower bound on primordial power spectrum from halo substructure](https://arxiv.org/abs/2607.20884)
...
### [23] [Reviving the Affleck-Dine Curvaton Scenario with Compensated Isocurvature Perturbations](https://arxiv.org/abs/2607.21008)
...
### [24] [Inferences for f(R) Models from Late-Time Megamaser Observational Data](https://arxiv.org/abs/2607.21129)
...
### [25] [Hubble tension: the shape wall](https://arxiv.org/abs/2607.21244)
...
### [26] [Contribution to the 2026 Cosmology session of the 60th Rencontres de Moriond: Galactic moments: Understanding polarized foregrounds complexity in the quest for CMB primordial $B$ modes with LiteBIRD](https://arxiv.org/abs/2607.21247)
...
### [27] [Web-Halo Model Peak-Background Split (WHM-PBS): halo bias as a distribution, not a number](https://arxiv.org/abs/2607.21334)
...
### [28] [Hubble tension: a short review of theoretical explanations](https://arxiv.org/abs/2607.21497)
