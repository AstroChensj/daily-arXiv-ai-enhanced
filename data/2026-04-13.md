...
TL;DR: This paper applies differentiable probabilistic programming with GPU acceleration to model the Galactic Center gamma-ray Excess, enabling efficient, flexible probabilistic inference over complex astrophysical data.


<details>
  <summary>Details</summary>
Motivation: Address the complex, large model space in astrophysical gamma-ray analyses, specifically the Galactic Center gamma-ray Excess (GCE) puzzle.

Method: Develop a differentiable forward model and likelihood leveraging GPU acceleration and vectorization, allowing for probabilistic modeling of a continuum of spatial morphologies; perform efficient inference using variational methods.

Result: Established a framework capable of fully probabilistic inference over a large model space related to GCE emission, demonstrating computational efficiency and flexibility.

Conclusion: Differentiable probabilistic programming enables flexible and efficient analyses of complex astrophysical gamma-ray datasets, exemplified by application to the GCE puzzle, supporting advanced model-space exploration.
...
TL;DR: The paper presents the first all-sky search for Galactic supernova dust echoes using 12 years of NEOWISE mid-infrared data and machine learning. They achieve high classification accuracy, find only Cassiopeia A exhibiting echoes at current sensitivity, and compile a large echo catalog for further study, paving the way for advanced future surveys.


<details>
  <summary>Details</summary>
Motivation: There is a discrepancy between the expected Galactic core-collapse supernova rate and the lack of optically visible supernova detections in the past 400 years. Identifying dust-obscured, missed supernova events via their mid-infrared dust echoes can address this gap.

Method: An all-sky, untargeted search was conducted using difference imaging on 12 years of time-resolved NEOWISE co-adds (2009-2022) to detect thermal dust echoes. A convolutional neural network was trained using echo features from Cassiopeia A and archival catalogs to classify transient candidates into dust echoes, point sources, artifacts, and high proper motion stars. The classifier was applied to approximately 11 million transient candidates to identify spatial over-densities of echoes.

Result: The model achieved approximately 94% accuracy in distinguishing dust echoes from other sources. Cassiopeia A was the only region exhibiting detectable dust echoes at the WISE sensitivity threshold, consistent with its unique characteristics. A catalog of 20,477 time-resolved echo positions of Cas A within 10 degrees was produced, which is being utilized for interstellar medium studies with the James Webb Space Telescope.

Conclusion: This study demonstrates the feasibility of detecting dust-obscured Galactic supernova events via their thermal dust echoes using time-resolved mid-infrared data and machine learning classification. The findings provide a foundation for future higher-sensitivity, higher-resolution surveys with the Roman Space Telescope that will significantly enhance detection capabilities.
...
TL;DR: This work simulates and assesses strategies for detecting GeV--TeV emission from short GRBs associated with gravitational wave detections of binary neutron star mergers using CTAO, finding that about 5% can be detected with optimized follow-ups, emphasizing the importance of viewing angle information to improve detection rates.


<details>
  <summary>Details</summary>
Motivation: The detection of gravitational waves from binary neutron star mergers and associated electromagnetic signals opens new opportunities in multi-messenger astronomy. The recent detection of TeV emission from GRBs motivates the use of the Cherenkov Telescope Array Observatory (CTAO) to follow-up and detect such high-energy signals efficiently.

Method: A multi-step simulation pipeline is used to evaluate GeV--TeV GW follow-up strategies for CTAO. Simulated BNS mergers with corresponding GW detections are combined with phenomenological models of gamma-ray emission, including off-axis jet scenarios. CTAO observations are simulated incorporating instrument response, sky tiling, integration times, and observational conditions. Both variable and constant integration time strategies are considered.

Result: An optimized follow-up strategy shows that about 5% of simulated GW-associated short GRBs produce GeV--TeV radiation detectable by CTAO. Detectability depends strongly on jet opening and viewing angles, implying that inclusion of viewing angle estimates in GW alerts could improve targeting. The approach supports further follow-up observations and advanced strategies leveraging galaxy distributions and synergy with future detectors.

Conclusion: Optimized follow-up observations with CTAO can significantly enhance the rate of detecting high-energy counterparts to GW events from BNS mergers, motivating incorporation of viewing angle information and the development of sophisticated observation strategies to improve joint GW-GRB detections in future observing runs.
...
TL;DR: Using the Effelsberg telescope to search for single pulses, this study discovered a new FRB, detected known and new RRATs, and found that single pulse detection rates vary with Galactic coordinates, implying a faint Galactic transient population.


<details>
  <summary>Details</summary>
Motivation: To detect pulsars and other radio transients by searching for single pulses in the northern part of the all-sky High Time Resolution Universe survey.

Method: Conducting a single pulse search using the 100 m Effelsberg Radio Telescope, analyzing dispersion measures, pulse widths, fluences, and positional data for pulsars, RRATs, and FRBs in the survey data.

Result: Discovery of the first fast radio burst (FRB20110220A) with the Effelsberg telescope, first L-band detection of RRAT J2028+28 with improved position and burst rate limits, discovery of a new RRAT J0404+53, detection of eight new single pulse trains and 272 faint isolated single pulse candidates, and identification of directional dependence of single pulse detection rates.

Conclusion: The direction-dependent detection rates indicate a faint Galactic single pulse population exists, enhancing the understanding of transient radio source distribution in the Galaxy.
...
TL;DR: A 1.5-year radio monitoring of FRB 20220912A using CHIME reveals high activity phases, bimodal wait times, significant total energy emission, a slight increase in DM, and unique local environmental conditions distinct from other active repeating FRBs.


<details>
  <summary>Details</summary>
Motivation: To understand the characteristics, activity, and local environment of the highly active repeating fast radio burst source FRB 20220912A.

Method: Conducted a radio monitoring campaign using CHIME/Pulsar over 1.5 years, analyzing ~200 hours of data and a sample of 828 bursts within the 400-800 MHz band.

Result: The source shows high activity for ~10 weeks with a bimodal wait-time distribution, a total emitted energy estimated at 2x10^{43} ergs, a weak linear increase in dispersion measure (DM), and no significant rotation measure (RM) trend. Its unique DM and RM evolution suggests a distinct local environment compared to other active repeaters.

Conclusion: FRB 20220912A exhibits unique temporal and energetic properties along with distinct DM and RM behavior, implying it resides in a local environment different from other known active repeaters, enhancing the understanding of FRB source environments.
...
TL;DR: Using 15 years of Fermi-LAT data from 1576 blazars, this work precisely measures the extragalactic background light's optical depth up to redshift 4.3, detecting attenuation with high significance and confirming agreement with recent models.


<details>
  <summary>Details</summary>
Motivation: To obtain a precise measurement of the EBL, which is critical for probing models of star formation and galaxy evolution by quantifying the integrated emission of stars, galaxies, and black holes across ultraviolet to infrared wavelengths.

Method: The authors analyzed 15 years of Fermi-LAT gamma-ray data from 1576 blazars, detecting EBL attenuation via absorption imprints on blazar spectra across 19 redshift bins within the range 0 to 4.3.

Result: Detected EBL attenuation with approximately 23 sigma significance, measured optical depth in 19 redshift bins, reconstructed EBL evolution, and validated consistency with recent theoretical models, representing the most accurate determination of EBL using GeV gamma-ray data to date.

Conclusion: The study provides the most precise measurement to date of the extragalactic background light (EBL) optical depth using GeV gamma rays, confirming general consistency with recent EBL models and improving understanding of its evolution up to redshift 4.3.
...
TL;DR: Using JWST mid-IR spectroscopy at two epochs ~1 year apart revealed evolving dust and gas interactions in SN 1987A's ejecta and equatorial ring, highlighting dynamic changes and the importance of ongoing observations.


<details>
  <summary>Details</summary>
Motivation: To investigate the temporal evolution and physical properties of Supernova 1987A and its surrounding components using spatially resolved mid-infrared spectroscopy.

Method: Utilizing two epochs of mid-infrared spatially resolved spectroscopic observations of SN 1987A at 35.4 and 36.4 years after the explosion, conducted with the Mid-Infrared Instrument Medium Resolution Spectrometer on the James Webb Space Telescope.

Result: The equatorial ring dust continuum showed little overall evolution but spatially varied, with inner regions fading and outer regions brightening. Broad ejecta emission lines evolved rapidly, driven by ejecta/equatorial ring interaction onset. Some emission lines from the ring faded, while mid-IR H2 emission was detected in the ejecta for the first time. Diagnostics indicate the dense Fe-rich ejecta has reached the reverse shock.

Conclusion: The temporal evolution of the ejecta and equatorial ring interaction is complex, with spatially varying changes in dust and emission lines indicating ongoing dynamic processes. Continued JWST monitoring is vital to understand these evolving aspects of SN 1987A.
...
TL;DR: Using very-high-energy γ rays from 45 sources, the study accurately reconstructs the local extragalactic background light, confirming it aligns with galaxy counts and deep-space data and challenging reported near-IR excesses, thereby affirming that known galaxies explain most of the optical and near-IR background.


<details>
  <summary>Details</summary>
Motivation: To measure the local extragalactic background light (EBL) intensity and test its consistency with galaxy counts and direct measurements using very-high-energy (VHE) γ rays.

Method: Analysis of 268 spectra from 45 sources observed with Imaging Atmospheric Cherenkov telescopes, employing model-dependent rescaling of seven EBL templates, derivation of template-marginalized TeV optical depths, and combination with Fermi-LAT GeV data to reconstruct the EBL at redshift zero using empirical and physically motivated models.

Result: Seven EBL templates require minimal rescaling (≤10%) to fit γ-ray attenuation, the galaxy-count-anchored model fits best, reconstructed EBL intensity matches integrated galaxy light within 2-3 nW m⁻² sr⁻¹, consistent with low-zodiacal-light measurements, and contradicts near-IR excess reported by IRTS and CIBER, implying most optical and near-IR background originates from known galaxies with limited room for additional diffuse components.

Conclusion: Known galaxy populations mostly account for the optical and near-infrared extragalactic background light, as confirmed by very-high-energy γ-ray attenuation measurements consistent with galaxy counts and deep-space observations, restricting the presence of an additional diffuse EBL component.
...
### [9] [Primordial Neutron Stars](https://arxiv.org/abs/2604.08651)
*Gordan Krnjaic,Duncan Rocha,Huangyu Xiao*

Main category: astro-ph.CO

TL;DR: This paper suggests that if the early universe had a very large baryon asymmetry, small-scale density perturbations could gravitationally collapse and form primordial neutron stars before BBN, with masses potentially as low as 0.1 solar masses, followed by entropy injection to match observed baryon abundances.


<details>
  <summary>Details</summary>
Motivation: To explore the possibility of neutron star formation in the early universe due to an initially large baryon asymmetry, providing an alternative cosmological scenario.

Method: They analyze the implications of a large baryon asymmetry $Y_B \gg 10^{-10}$ causing baryonic mass inside the horizon to exceed the neutron star mass before BBN, leading to gravitational collapse of density perturbations arrested by nuclear pressure.

Result: Primordial neutron stars could form shortly after horizon re-entry with masses as low as ~0.1 solar masses, and a subsequent entropy injection restores the observed baryon asymmetry to preserve standard BBN predictions.

Conclusion: The paper proposes that baryonic neutron stars could form in the early universe under conditions of large initial baryon asymmetry, resulting in primordial neutron stars of unusually low mass, distinct from those formed by stellar collapse.
...
### [10] [FolpsD: combining EFT and phenomenological approaches for joint power spectrum and bispectrum analyses](https://arxiv.org/abs/2604.08895)
...
TL;DR: This paper enhances galaxy clustering analysis by jointly modeling the power spectrum and bispectrum with an effective field theory approach and damping factors, achieving up to 30% tighter cosmological constraints on DESI DR2 mocks, particularly for dark energy parameters, and provides a publicly available code implementation.


<details>
  <summary>Details</summary>
Motivation: To improve cosmological parameter constraints by exploiting complementary information from galaxy clustering statistics on different scales, specifically combining small-scale power spectrum data with large-scale bispectrum measurements.

Method: Extended the FOLPS code to combine one-loop EFT galaxy power spectrum with tree-level galaxy bispectrum projected onto the Sugiyama tripolar spherical harmonics basis; incorporated a line-of-sight damping factor to access additional small-scale information; tested on DESI DR2 galaxy mocks.

Result: Joint analysis of power spectrum and bispectrum improves constraints and reduces parameter degeneracies; inclusion of damping extends analysis to smaller scales without significant bias for LRG-like samples, tightening constraints on parameters like $A_s$ and $\omega_{cdm}$ by up to 30%; for $w_0w_a$CDM model, constraints on dark energy parameters $w_0$ and $w_a$ improved by 15% and 21%, respectively, with slight evidence for deviation from constant dark energy; limitations noted for low signal-to-noise tracers and models with degenerate shapes.

Conclusion: The combined approach using power spectrum and bispectrum with damping provides significantly improved and robust cosmological parameter constraints for galaxy clustering data, especially for LRG-like samples, while highlighting potential limitations for noisy tracers and certain cosmological models; the method and code are publicly available for further use.
...
### [11] [Bounding axion dark energy](https://arxiv.org/abs/2604.09141)
*Gary Shiu,Flavio Tonioni,Hung V. Tran*

Main category: astro-ph.CO

TL;DR: The paper derives analytic bounds on axion mass and decay constant in cosmological settings, uses observational data and quantum gravity considerations to exclude large parameter regions, challenging simple axion quintessence dark energy models.


<details>
  <summary>Details</summary>
Motivation: To analyze cosmological solutions of (pseudo)scalar theories with periodic potentials in the presence of various cosmological fluids, aiming to understand constraints on axion parameters in the context of dark energy and quantum gravity.

Method: Derivation of an analytic bound relating the axion mass parameter and decay constant, valid independent of initial field conditions, applied to models of thawing quintessence and compared against observational data and quantum gravity constraints.

Result: The derived analytic bounds constrain axion dark energy models when combined with observational data from DESI and supernovae, and when combined with quantum gravity constraints, exclude large regions of axion parameter space, pushing axion masses above the Hubble scale and challenging basic axion quintessence models.

Conclusion: The combined analytic and observational constraints significantly restrict viable axion quintessence parameter space, implying tensions for simple axion dark energy models with masses below the Hubble scale.
...
### [12] [The Cosmic Web and Its Filaments: Neutrino Mass from Topology and Persistent Homology](https://arxiv.org/abs/2604.09148)
*Graziano Rossi,Hogyun Yu,Michaël Michaux*

Main category: astro-ph.CO

TL;DR: This paper uses advanced topological methods and simulations to reveal how massive neutrinos uniquely affect cosmic web filaments, enabling novel constraints on neutrino mass and hierarchy, with implications for future galaxy surveys.


<details>
  <summary>Details</summary>
Motivation: To characterize the impact of massive neutrinos on the multiscale cosmic web and to leverage cosmic web topology for constraining neutrino mass and hierarchy, which is a major challenge in particle physics.

Method: Application of discrete Morse theory, global topology, and persistent homology to quantify topological features of cosmic web structures like filaments using two independent sets of N-body simulations, including particle-based neutrino implementations to mitigate Poisson shot noise.

Result: Neutrinos leave distinct imprints on filaments and skeleton connectivity with mass-dependent signatures most pronounced at high redshift (z~2), detectable at the few-percent level for neutrino masses as small as ~0.1 eV. Filaments provide an ideal environment to isolate neutrino effects, with systematics assessed via comparison of two neutrino implementations.

Conclusion: The cosmic web topology and persistent homology provide a powerful, scale-adaptive, parameter-free framework to detect and constrain neutrino masses and mass hierarchy, establishing a promising method for upcoming galaxy surveys.
...
### [13] [Analytic compression of the effective field theory of the Lyman-alpha forest](https://arxiv.org/abs/2604.09407)
*N. G. Karaçaylı,M. Ivanov,R. de Belsunce,C. Ravoux,J. M. Sexton,Z. Lukić*

Main category: astro-ph.CO

TL;DR: This paper improves effective field theory modeling of the Lyα forest 1D flux power spectrum by compressing parameters and marginalizing analytically, overcoming degeneracies and stochastic projection effects. Using simulations and DESI DR1 data, it forecasts high-precision cosmological constraints comparable to current emulator methods, while reducing computational demands.


<details>
  <summary>Details</summary>
Motivation: The 1D flux power spectrum of the Lyα forest contains rich cosmological information at small scales, sensitive to effects like massive neutrinos and warm dark matter. However, applying effective field theory (EFT) to this spectrum is challenging due to parameter degeneracies and new stochastic terms from line-of-sight projection.

Method: The authors compress the EFT parameter space using Fisher matrix formalism, linearize compression directions for analytic marginalization, and use hydrodynamical simulations plus DESI DR1 data to establish baseline EFT parameters and compression directions. They then marginalize deviations to forecast cosmological parameter constraints.

Result: They find that only a limited number of parameters (linear bias, two leading 1D stochastic terms, and three principal EFT combinations) are needed to saturate cosmological constraints across redshift bins. Forecasted precision on the amplitude and slope of the linear matter power spectrum is 10% and 2%, respectively, competitive with emulator-based methods including observational systematics.

Conclusion: The developed EFT parameter compression and marginalization approach effectively mitigates degeneracies and stochastic effects in the Lyα forest 1D flux power spectrum analysis, enabling precise cosmological parameter constraints with reduced computational cost, matching or surpassing existing emulator-based analyses.
