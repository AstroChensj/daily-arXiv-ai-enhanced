...
TL;DR: This study demonstrates that for Euclid cosmological data, modelling likelihood skewness via an Edgeworth expansion does not significantly improve parameter inference over Gaussian assumptions, validating the use of the simpler Gaussian likelihood model.


<details>
  <summary>Details</summary>
Motivation: To address the skewness present in parameter inference likelihood modelling for cosmological data analysis.

Method: Modelling the likelihood via an Edgeworth expansion incorporating the complete skewness tensor (1-point, 2-point, and 3-point correlators) and performing a change of basis that normalizes the precision matrix to the identity, simplifying calculations.

Result: Found that only the diagonal components of the skewness tensor need to be included for parameter inference, with full tensor inclusion adding noise without accuracy gains. Cosmological constraints remain effectively unchanged when compared to Gaussian likelihood assumptions, with less than 5% variation in parameter figure of merit. No detectable excess skewness was observed in large-scale Euclid mock catalogues due to shot noise.

Conclusion: The Gaussian likelihood assumption is robust and sufficient for Euclid 2-point statistics analyses in both Fourier and configuration space, making the more complex Edgeworth expansion unnecessary for improving parameter inference in this context.
...
TL;DR: The paper simulates primordial black hole mergers in clusters to explain JWST's high-redshift supermassive black holes, using the Smoluchowski equation and Monte Carlo methods to reveal growth timescales and mass evolution.


<details>
  <summary>Details</summary>
Motivation: To explain the presence of high-redshift supermassive black holes observed as 'little red dots' by JWST through primordial black hole clustering.

Method: Performed comprehensive simulations of successive primordial black hole mergers within clusters by solving the Smoluchowski coagulation equation, deriving coagulation kernels with and without mass segregation effects, and using a Monte Carlo method with the full-conditioning scheme and discrete inverse transformation.

Result: Determined the runaway timescales of PBH clusters and the evolution of PBH mass populations across cosmic redshifts, influenced by cluster size and density.

Conclusion: Primordial black hole clustering on small scales can account for the formation and growth of high-redshift supermassive black holes observed by JWST, supported by simulation results of PBH mergers and population evolution.
...
TL;DR: This paper constrains the minimal length effects from the Generalized Uncertainty Principle on cosmology using growth rate and background data, finding mild observational support for a GUP-induced dark energy modification to ΛCDM.


<details>
  <summary>Details</summary>
Motivation: To investigate the effects of the Generalized Uncertainty Principle (GUP) and the associated minimal length scale on cosmological dynamics and structure formation at late times.

Method: Use redshift-space distortion measurements combined with background cosmological data (cosmic chronometers, baryon acoustic oscillations, Type Ia supernovae) to constrain the GUP deformation parameter β, applying a modified Raychaudhuri equation from a deformed Poisson bracket within the ΛCDM framework, resulting in a one-parameter dynamical dark energy model.

Result: Observational constraints indicate a systematically negative deformation parameter β with ΛCDM within the 95% credible interval; model comparison using Akaike Information Criterion shows weak to strong support for the GUP-modified model depending on supernovae data sets, while Bayesian evidence suggests only weak preference.

Conclusion: The study reveals that imprints of the GUP and corresponding minimal length can influence late-time cosmological structure formation, offering a viable one-parameter dynamical dark energy modification to ΛCDM that is mildly favored by current observational data.
...
TL;DR: This study models the impact of traversable wormholes on companion star motion in binary systems, showing that with improved radial velocity measurements and advanced analysis techniques, wormhole signatures can be observationally distinguished from black holes or triple systems over time.


<details>
  <summary>Details</summary>
Motivation: To explore the observational signatures of traversable wormholes by studying their effects on companion star motion in binary systems.

Method: Modeling a binary system with a traversable wormhole candidate and a companion star, analyzing perturbing accelerations and radial velocity changes, comparing with binary black hole and triple system scenarios, and applying spectral and non-parametric data analysis methods.

Result: Radial velocity perturbations caused by a wormhole are detectable with near-future observational accuracy (1.5 km/s) within available time spans; with realistic accuracy (10 km/s), statistically significant detection requires around 17 years of data, while spectral and non-parametric methods reduce data accumulation time compared to matched-filtering alone.

Conclusion: Observational methods, particularly spectral and non-parametric analysis of radial velocities in binary systems, provide a viable approach to detect traversable wormholes distinguishing them from black holes or triple systems, given sufficient data accuracy and accumulation time.
...
TL;DR: Using calibrated gamma-ray bursts as distance indicators, this study finds no strong evidence for evolving dark energy and obtains a Hubble constant value that reduces the Hubble tension, supporting a cosmological constant and flat spatial geometry.


<details>
  <summary>Details</summary>
Motivation: Motivated by the recent DESI results suggesting possible dynamical behavior of dark energy, this paper aims to verify or reject time-evolution of the dark energy equation of state using calibrated gamma-ray burst correlations extending to high redshifts.

Method: The study calibrates GRB Combo correlations using three type Ia supernova catalogs at low redshift and Bézier interpolation of the Hubble rate, employs a model-independent redshift-binned DE parametrization to reconstruct ω(z), and explores the impact of spatial curvature in the analyses.

Result: The calibrated Combo correlation yields a Hubble constant of approximately 70 km/s/Mpc, which alleviates the Hubble tension. Spatially curved cosmological models are disfavored. Despite some limited ''phantom'' behavior at low redshifts due to data scarcity, results at higher redshift support a cosmological constant scenario. No significant evidence supports dynamical dark energy.

Conclusion: GRBs calibrated with the Combo correlation provide measurements consistent with the cosmic distance ladder and do not show significant evidence for dynamical dark energy. The approach alleviates the Hubble tension and disfavors spatial curvature in cosmological models.
...
TL;DR: A novel quintessence model with non-minimal coupling explains late-time dark energy weakening seen in DESI data, showing better agreement with observations than ΛCDM and w0waCDM models by modifying dark matter-dark energy interaction and evolution.


<details>
  <summary>Details</summary>
Motivation: To explain the late-time weakening of dark energy indicated by recent DESI measurements and to provide a model accounting for the observed dark energy dynamics.

Method: Propose a new non-minimally coupled quintessence model where the quintessence density decreases only after dominating the universe, with a coupling that induces a sign change in energy transfer between dark matter and dark energy while keeping the scalar field canonical.

Result: The model naturally accounts for the late-time onset of dark energy weakening, shows an effective crossing behavior in the dark energy sector due to modified dark matter evolution, and is favored over ΛCDM and w0waCDM models by current cosmological data.

Conclusion: This new non-minimally coupled quintessence model offers a promising explanation for late-time dark energy dynamics and its weakening, potentially improving our understanding of cosmic evolution compared to standard models.
...
TL;DR: This paper analyzes gravitational wave fluctuations caused by strong and weak lensing using perturbative methods and diagrammatic rules, confirming that key consistency relations hold and revealing magnification and Fresnel scale shifts due to weak lensing.


<details>
  <summary>Details</summary>
Motivation: To understand how wave optics lensing affects gravitational waves' amplitude and phase fluctuations when both strong lensing and cosmological weak lensing coexist.

Method: Use geometric optics approximation for the strong lens and treat weak lensing potential perturbatively up to second order; develop a diagrammatic method to systematically evaluate weak lensing effects.

Result: Derived amplification factor including both strong and weak lensing; demonstrated that established consistency relations remain valid with strong lensing; identified magnification and Fresnel scale shift effects in weak lensing signals.

Conclusion: The presence of a strong lens does not alter the fundamental consistency relations of weak lensing fluctuations, and weak lensing causes both increased magnification and Fresnel scale shifts in gravitational wave signals.
...
TL;DR: This paper introduces persistence strips, a topological data analysis tool from persistent homology, to improve cosmological constraints on neutrino mass. Applied to simulations, this method breaks degeneracies in cosmological parameters and yields precise neutrino mass constraints, highlighting the potential for future observational data analysis.


<details>
  <summary>Details</summary>
Motivation: Traditional probes of neutrino mass face challenges due to degeneracies with other cosmological parameters, limiting the accuracy of neutrino mass constraints from cosmological data.

Method: The paper introduces a novel topological summary method using persistent homology called persistence strips, which segment Betti curves by topological persistence to reduce two-dimensional persistence diagrams into one-dimensional curves. This method is applied to the FLAMINGO cosmological simulation suite and incorporates an emulator over a 10-dimensional cosmological parameter space including neutrino mass and degenerate parameters.

Result: Persistence strips demonstrate strong sensitivity to neutrino mass, providing neutrino mass constraints with uncertainties as low as 0.05 eV for total matter and 0.13 eV for dark matter only within a relatively small simulation volume. They offer roughly twice the constraining power of unbinned Betti curves and can systematically break degeneracies between neutrino mass and other parameters. The strongest constraints arise from void topology.

Conclusion: Topological summaries based on persistent homology, especially persistence strips, offer a powerful and promising approach to constrain neutrino mass in cosmology by leveraging multi-scale and environment-dependent information from the cosmic web. These methods are particularly promising for application to weak lensing data that probes the total matter distribution directly.
...
TL;DR: Gravitational-wave data shows a sharp drop in black hole merger rates between 12 and 16 solar masses. This supports the existence of a distinct subpopulation of black holes formed by failed supernovae around 10 solar masses, explaining the observed mass distribution features.


<details>
  <summary>Details</summary>
Motivation: To explain the observed sharp drop in the rate of merging black holes between component masses of 10 to 15 solar masses, which is not fully accounted for by progenitor core compactness alone.

Method: Analyzed 153 gravitational-wave observations from the GWTC-4.0 catalog, focusing on the primary mass distribution of merging black holes. Considered the presence of a distinct subpopulation of failed-supernova black holes possibly separated by a mass gap.

Result: Confirmed a strong peak in the primary mass distribution at around 10 solar masses with a rate density of approximately 7.36 (with uncertainty). Observed a sharp drop to near zero rate in the 12-16 solar mass range, followed by a rise above 16 solar masses. This reveals structure in the 10-20 solar mass range, consistent with a distinct population of failed-supernova black holes separated by a mass gap.

Conclusion: The sharp rate drop in merging black holes between 12 and 16 solar masses and the peak at 10 solar masses can be explained by the existence of a separate population of black holes formed via failed supernovae through direct collapse. This distinct population contributes to the overdensity and rate structure in the 10-20 solar mass range.
...
TL;DR: Nearby merger-induced GRBs can be well localized by the LIGO-Virgo-KAGRA network in O5 and their optical counterparts are detectable if sufficiently deep observations (>23 mag) are made, shifting the main challenge from localization to observation depth and counterpart identification.


<details>
  <summary>Details</summary>
Motivation: The motivation is to understand how effectively electromagnetic counterparts to gravitational wave sources, specifically nearby merger-induced GRBs, can be localized and detected to enable comprehensive multimessenger astronomy investigations, given challenges in their faintness and fast variability.

Method: The study simulates localization of nearby merger-induced GRBs by the LIGO-Virgo-KAGRA network during the fifth observing run (O5) and evaluates optical counterpart detectability using observed optical afterglow lightcurves and a kilonova template lightcurve scaled by distance.

Result: The results demonstrate that these GRB events can be localized to small sky areas (few to tens of square degrees) allowing detection of counterparts by at least one optical telescope during O5. Detectability critically depends on observational depth, with counterparts being fainter than 22 magnitude within a day; thus, telescopes reaching depths beyond 23 magnitude are essential.

Conclusion: The primary limitation in multimessenger discoveries of these events during O5 is achieving sufficient observational depth and correctly identifying true counterparts amid unrelated transients, rather than the gravitational wave localization itself.
...
TL;DR: This study shows that gamma-ray AGN detected by Fermi-LAT tend to be seen along voidier lines of sight than optical quasars, and this difference is likely due to enhanced gamma-ray flux caused by interactions along the void-filled paths rather than local source properties.


<details>
  <summary>Details</summary>
Motivation: To investigate the role of cosmic voids on the propagation of high-energy photons and understand why AGN detected by Fermi-LAT lie along voidier lines of sight compared to optically detected quasars.

Method: Analyzed the fraction of lines of sight intersecting cosmic voids (voidiness) for Fermi-LAT detected AGN and SDSS quasars, studied the possible impact of intergalactic magnetic fields and line-of-sight interactions on gamma-ray flux, and compared voidiness distributions including very-high-energy AGN detected by Cherenkov telescopes.

Result: Observed that a slight increase (∼0.1% per Mpc) in gamma-ray flux due to line-of-sight interactions through voids can explain the difference in voidiness between gamma-ray AGN and optical quasars; no significant local void effect found; about 28% of gamma-ray sources lie within voids, consistent with random distributions.

Conclusion: The difference in voidiness distributions between gamma-ray AGN and optical quasars likely arises from line-of-sight propagation effects in cosmic voids rather than from local emission environments of the sources.
...
TL;DR: The paper attributes the spectral hardening in cosmic ray fluxes to Galactic-scale outflows like the eROSITA bubbles, using a transport model that fits AMS-02 data well and aligns with observed kinematic constraints, providing a parsimonious alternative to diffusion break explanations.


<details>
  <summary>Details</summary>
Motivation: To explain the observed spectral hardening in Galactic cosmic ray fluxes, addressing limitations in existing models based on microphysical variations in scattering properties.

Method: A phenomenological transport model incorporating an advective outflow boundary representing macroscopic Galactic outflows, such as the eROSITA bubbles, was employed to analyze cosmic ray data.

Result: The model naturally reproduces the 300 GV hardening in secondary-to-primary cosmic ray ratios; fits to AMS-02 precision data suggest a local inner halo boundary of approximately 5 kpc and an outflow speed near 360 km/s, consistent with multi-wavelength observations of eROSITA outflows.

Conclusion: Spectral hardening in Galactic cosmic rays is primarily governed by macroscopic Galactic outflows rather than changes in diffusion properties, offering a simpler and testable alternative to diffusion coefficient break models without additional free parameters.
...
TL;DR: This work uses microshots from repeating FRB 20220912A to accurately measure its true dispersion measure, revealing a stable DM_real around 219.380 pc cm^-3. It shows that intrinsic burst morphology causes pseudo DM contamination in DM measurements, a common issue among repeating FRBs, emphasizing the need to consider morphological effects in DM analysis.


<details>
  <summary>Details</summary>
Motivation: To accurately determine the true dispersion measure (DM_real) of fast radio bursts (FRBs) by accounting for contamination from intrinsic burst morphology (DM_pseudo), particularly focusing on the highly active repeating FRB 20220912A.

Method: The study utilizes extremely short-duration broadband microshots from FRB 20220912A, assumes a stable non-magneto-ionic environment with minimal DM_real variation, and negligible intrinsic morphological time delay in microshots. Two new microshots were identified and combined with existing data. Consistency of DM values over time was analyzed and compared with narrow bright bursts. Additionally, a survey of five repeating FRBs was conducted to assess the prevalence of DM_pseudo.

Result: The research determined a consistent DM_real value of 219.380 ± 0.004 pc cm^-3 for FRB 20220912A over a month. Bright, narrow bursts also yield DM estimates consistent with this DM_real. It was found that DM_pseudo is common among repeating FRBs, with typical variations around 10 pc cm^-3 at 1.2 GHz, indicating morphological effects significantly influence DM measurements.

Conclusion: Microshots and narrow bursts are effective tools for accurately probing the true dispersion measure of FRBs. Intrinsic burst morphology significantly contaminates DM measurements, producing a pseudo DM component that must be accounted for to avoid misinterpretation.
...
TL;DR: This study uses Gaussian process regression to model X-ray variability of the black hole candidate Swift J1727.8-1613, recovering quasi-periodic oscillations and turbulent timescales, supporting a magnetically dominated accretion flow and revealing rapid disk changes preceding jet ejection.


<details>
  <summary>Details</summary>
Motivation: To understand and link the observed X-ray variability in black hole X-ray binaries to the underlying magnetohydrodynamic (MHD) dynamics of their accretion flows, which remains a challenging problem.

Method: Applied Gaussian process (GP) regression using a composite kernel model consisting of one stochastically driven damped simple harmonic oscillator (SHO) and two damped random walk (DRW) components to multi-band X-ray light curves of Swift J1727.8-1613 from the Insight-HXMT telescope.

Result: The SHO component successfully recovered quasi-periodic oscillations (QPOs) consistent with fundamental Alfvén modes, with quality factors increasing from ~3 to ~10. An anti-correlation was found between QPO frequency and short DRW damping timescale. Estimated an effective viscosity parameter α≈0.1 indicative of strongly magnetized accretion flows. Observed a rapid collapse of relaxation timescales near relativistic jet ejection, implying rapid disk energy reorganization before jet launching.

Conclusion: Gaussian process regression with physically motivated kernels effectively links X-ray timing variability to MHD accretion dynamics in black hole X-ray binaries, providing new diagnostics of magnetic disk-coronal structures and accretion flow properties relevant to jet launching mechanisms.
...
TL;DR: This paper reports the detection of a unique FRB-associated magnetar X-ray burst from SGR J1935+2154, characterized by a thermal blackbody spectrum and possible QPO, indicating a special origin mechanism and expanding knowledge of FRB sources.


<details>
  <summary>Details</summary>
Motivation: To explore the nature of FRB-associated magnetar X-ray bursts (MXBs) and expand the limited sample size to better understand their physical mechanisms.

Method: Detection and analysis of a bright FRB-associated MXB (MXB 221120) from magnetar SGR J1935+2154 using data from GECAM, including temporal and spectral examination and identification of features like light curve composition and possible quasi-periodic oscillations (QPO).

Result: MXB 221120 exhibits unique temporal and spectral characteristics, including a light curve described by a single FRED function with narrow pulses, a possible ~18 Hz QPO, and a blackbody spectrum with a temperature of 18.6 keV, marking it as the first thermal spectrum MXB associated with FRB from SGR J1935+2154. It differs notably from other MXBs by its longer duration and higher temperature, suggesting an unusual production mechanism.

Conclusion: The distinctive properties of MXB 221120 imply it arises from special physical conditions and mechanisms different from typical MXBs, enhancing the understanding of FRB production by magnetar activity.
...
TL;DR: This study uses high-sensitivity MeerKAT observations of three pulsar binaries to analyze polarization and propagation effects, revealing magnetic field structures and plasma properties through eclipse and orbital phase-dependent variations.


<details>
  <summary>Details</summary>
Motivation: To utilize eclipsing pulsar binaries and high-mass companion binaries as probes for studying plasma properties in magneto-ionic environments.

Method: MeerKAT high-sensitivity polarimetric observations of three pulsar binaries (PSR J1740-3052, PSR J2051-0827, PSR J1748-2446A) measuring linear/circular polarization, dispersion measure, rotation measure, and scattering time.

Result: Observed strong orbital-phase-dependent propagation effects including multiple eclipses; smooth RM variation in PSR J1740-3052 indicating small-scale magnetic structures; frequency-dependent polarization profile changes in PSR J2051-0827; propagation effects in PSR J1748-2446A likely due to Faraday Conversion or multipath propagation.

Conclusion: The detailed polarimetric study characterizes propagation effects and magnetic structures within pulsar binary environments, advancing understanding of plasma conditions in these complex systems.
