...
TL;DR: This paper uses high-energy neutrino data from IceCube and ANTARES to constrain sub-asteroid mass primordial black holes as dark matter candidates, offering complementary limits to gamma-ray observations and highlighting the potential of future neutrino detectors to improve these constraints.


<details>
  <summary>Details</summary>
Motivation: Primordial black holes (PBHs) are promising dark matter candidates with a wide range of masses and abundances, but current constraints still leave room for exploration, especially for sub-asteroid mass PBHs.

Method: Utilizing data from high-energy neutrino telescopes (IceCube and ANTARES), the study derives limits on sub-asteroid mass Schwarzschild PBHs with extended mass functions based on the diffuse high-energy neutrino flux from PBH evaporation and transient neutrino signals from PBHs near Earth.

Result: The derived neutrino-based constraints are slightly weaker than gamma-ray observation limits but serve as an independent complementary probe. Future neutrino detectors such as IceCube-Gen2 and KM3NeT could substantially improve constraints, potentially ruling out PBHs with masses up to several times 10^18 g as the sole component of dark matter.

Conclusion: High-energy neutrino observations provide a novel, independent method to constrain sub-asteroid mass PBHs as dark matter candidates, with future detectors promising tighter bounds that could exclude PBHs composing all dark matter in this mass range.
...
### [2] [Repopulating the pair-instability mass gap without sustained growth to massive IMBHs: the case of 47\,Tuc](https://arxiv.org/abs/2604.09773)
*Debatri Chattopadhyay,Daniel Marín Pina,Mark Gieles,Fabio Antonini,Fotios Fronimos Pouliasis*

Main category: astro-ph.HE

TL;DR: This paper models the formation of the most massive black hole in 47 Tuc, finding that either a few mergers of stellar BHs or the survival of massive primordial seeds can produce black holes consistent with observational limits, favoring a dark-remnant subsystem detectable by gravitational-wave observatories.


<details>
  <summary>Details</summary>
Motivation: To understand the formation and retention of the most massive black hole in the globular cluster 47 Tucanae, and to explore the implications for black hole populations and gravitational-wave observations.

Method: Employed the semi-analytical code cBHBd to couple cluster evolution with binary black hole dynamics, using numerical-relativity surrogate models to compute merger remnant masses, spins, and recoil kicks. Modeled 80,000 cluster realizations varying initial conditions like mass, density, IMF, and metallicity, considering a baseline and an extended-IMF scenario including primordial black hole seeds.

Result: Hierarchical mergers produce a most massive retained BH of approximately 45-70 solar masses with moderate spin (χ~0.65), limited to 1-3 mergers due to recoil kicks. Including primordial seeds creates a bimodal retained-mass distribution where in ~10% of cases a massive seed (>450 solar masses) survives with high mass and spin. Both scenarios align with observational upper limits on black hole mass in 47 Tuc and suggest a dark-remnant subsystem rather than a single intermediate-mass black hole.

Conclusion: The study concludes that the observed constraints on black hole mass in 47 Tuc can be explained by either hierarchical mergers of stellar-mass BHs or the survival of primordial massive seeds, favoring a dark-remnant subsystem over a single massive intermediate-mass black hole. The mass-spin distribution predicted can be tested by current and future gravitational-wave observatories.
...
### [3] [JWST Nebular Spectroscopy of SN 2023qov: Circumstellar Dust Emission in a Normal Type Ia Supernova](https://arxiv.org/abs/2604.09777)
...
### [4] [Even a precessing clock is right twice per orbit -- The super-periods of eRO-QPE2 and challenges for quasi-periodic eruption orbital models](https://arxiv.org/abs/2604.09788)
...
TL;DR: Timing analysis of eRO-QPE2's 32 X-ray eruptions reveals an underlying orbital period with hierarchical modulations, disfavoring certain astrophysical models, and supporting apsidal precession or triple-system scenarios, though limited data complexity hinders conclusive modeling.


<details>
  <summary>Details</summary>
Motivation: To analyze the quasi-periodic eruption (QPE) source eRO-QPE2 using timing analysis to understand its recurrence behavior and physical models governing it.

Method: Performed O-C (observed minus calculated) timing analysis of 32 QPE eruptions from a multi-mission X-ray campaign spanning 325 QPE cycles over a month, compared against accretion, orbital clock, and disk-collision models using parameter constraints including period derivatives and precession effects.

Result: The analysis supports both damped random walk behavior and presence of an underlying orbital period (~2.24 h) with two hierarchical super-periodic modulations (~4.4 d and ~95 d). Constraints on period derivative disfavor high eccentricity white dwarfs and massive black holes as sources via gravitational wave decay. Disk-collision models disfavour main-sequence stars as secondaries unless debris streams exist; stripped stars remain possible. The observed timing modulations are consistent with apsidal precession, disk precession in a limited parameter space, or a hierarchical triple system involving an outer massive black hole, but no robust EMRI trajectory solutions were found due to data limitations and complex parameter space.

Conclusion: The QPE recurrence in eRO-QPE2 can be explained by orbital dynamics including apsidal precession or hierarchical triple system models, while ruling out certain high-eccentricity or mass scenarios. However, definitive modeling is constrained by sparse data and complex parameter spaces.
...
### [5] [High Resolution X-ray Spectroscopy of the Nova-Like Cataclysmic Variable BZ Cam using Chandra HETG: Diagnosis of the ADAF-like (Advective) Hot Flow](https://arxiv.org/abs/2604.09840)
*Solen Balman,Eric M. Schlegel,Patrick Godon,Jeremy J. Drake,Edward M. Sion*

Main category: astro-ph.HE

TL;DR: This study analyzes Chandra HETG and broadband X-ray data of nova-like BZ Cam, revealing high-density, nonequilibrium ionization plasma with temperatures of a few to tens of million K. The data support an advective hot flow in the inner disk and detect additional components such as warm absorbers and power law emission, consistent with complex accretion processes.


<details>
  <summary>Details</summary>
Motivation: To investigate the ionization conditions and plasma properties of the hard X-ray emitting advective hot flows in the inner accretion disk of the nova-like Cataclysmic Variable BZ Cam.

Method: Analysis of Chandra HETG observations for detailed line diagnostics focusing on H- and He-like emission lines of Mg, Si, S, and Fe; plasma diagnostics using R and G line ratios; simultaneous spectral fitting of HEG, MEG, ROSAT, Chandra zero order, and NuSTAR data using VNEI and Bremsstrahlung models; addition of power law and warm absorber components in spectral modeling.

Result: Identification of high-density plasma (10^{12-14} cm^{-3}) with temperatures ranging from 3-6 million K (from He-like lines) to 10-30 million K (from Fe lines). Evidence of nonequilibrium ionization consistent with an ADAF-like hot accretion flow. Broadband spectral fits yield plasma temperatures of 3.4-6.3 keV and detect an additional power law component above 98% confidence. Orbital variations suggest X-ray dipping and require a warm absorber with ionization parameter log(ξ) ≈ 2.7–3.6 at significant confidence.

Conclusion: BZ Cam's X-ray emission originates from a high-density, nonequilibrium ionization plasma consistent with an advective hot accretion flow (ADAF-like). The spectral modeling indicates complex absorption and additional high-energy components, confirming the presence of warm absorbers and supporting the advective nature of the inner accretion disk plasma.
...
### [6] [To understand the radiative processes of pulsars and fast radio bursts with the FAST](https://arxiv.org/abs/2604.09987)
...
TL;DR: This paper reviews how FAST telescope observations offer new insights into the coherent radio emission mechanisms of pulsars and FRBs, encouraging future exploration with this sensitive facility.


<details>
  <summary>Details</summary>
Motivation: The longstanding mystery of the radiative mechanism behind coherent radio emissions from pulsars and the recent advent of fast radio bursts (FRBs) that share similarities with pulsar emissions motivated this study.

Method: Review of observational breakthroughs and data obtained from the highly sensitive Five-hundred-meter Aperture Spherical radio Telescope (FAST) to gain insights into the underlying physics of pulsars and FRBs.

Result: FAST observations have provided pivotal insights into the physics of pulsars and FRBs, potentially aiding in resolving the enigma of their coherent radio emission mechanisms.

Conclusion: The use of the FAST telescope opens a novel perspective on understanding pulsars and FRBs, encouraging further investigations using this highly sensitive instrument to solve the longstanding puzzle.
...
### [7] [Impact of Observational and Modelling Assumptions on Intergalactic Magnetic Field Constraints from TeV Gamma-Ray Bursts with the Cherenkov Telescope Array Observatory](https://arxiv.org/abs/2604.10097)
...
### [8] [Joint Observation of SGR J1935+2154 with \textit{Insight}-HXMT and KM40m during the active episode of October 2022](https://arxiv.org/abs/2604.10131)
...
### [9] [Lorentz invariance violation search with flaring active galactic nuclei observations of the first Large-Sized Telescope of CTAO](https://arxiv.org/abs/2604.10236)
*Cyann Plard,Sami Caroff,the CTAO-LST project*

Main category: astro-ph.HE

TL;DR: This study uses standardized analysis of very-high-energy AGN observations from the Cherenkov Telescope Array to search for intra-night variability and combines data across sources to constrain Lorentz invariance violation energy scales, overcoming intrinsic photon delay uncertainties.


<details>
  <summary>Details</summary>
Motivation: To detect or constrain potential violations of Lorentz invariance using rapid variability in very-high-energy sources, while addressing uncertainties from intrinsic photon delays within sources.

Method: A standardized analysis of AGN observations from the Large-Sized Telescope at the Cherenkov Telescope Array, including a systematic search for intra-night variability in archival data with significant excess detections.

Result: Constraints on characteristic energy scales for deterministic or stochastic Lorentz invariance violation effects were derived by combining observations of multiple sources at different redshifts.

Conclusion: By analyzing multi-source AGN observations with a consistent method, constraints on Lorentz invariance violation that account for intrinsic source effects can be effectively established.
...
### [10] [Multi-TeV $γ$-ray candidates from GRB 221009A: a downturn in the intrinsic $γ$-ray spectrum, an echo of the prompt emission phase, and intergalactic electromagnetic cascades](https://arxiv.org/abs/2604.10378)
*Timur A. Dzhatdoev,Jagdish C. Joshi,Abhijit Roy,Grigory I. Rubtsov,Anatoly A. Semenov*

Main category: astro-ph.HE

TL;DR: The paper analyzes LHAASO γ-ray data of GRB 221009A, revealing a downturn in the TeV spectrum. It explains this via neutron-related secondary emissions inside the GRB fireball, producing a high-energy synchrotron echo, and constrains the role of intergalactic cascades due to magnetic fields.


<details>
  <summary>Details</summary>
Motivation: Investigate the nature and origin of high-energy γ-ray emission from GRB 221009A, especially the downturn observed in the intrinsic spectrum at several TeV.

Method: Analyzed the γ-ray dataset from LHAASO observations to reconstruct the intrinsic spectrum; modeled neutron production from photohadronic interactions inside the GRB fireball; studied subsequent interactions of neutrons with surrounding matter and the resulting synchrotron emission; assessed the contribution of γ rays from intergalactic electromagnetic cascades under realistic magnetic field conditions.

Result: Identified a significant downturn in the intrinsic γ-ray spectrum above several TeV; proposed that neutrons from photohadronic interactions can produce observable GeV–TeV synchrotron photons as a high-energy echo of the GRB prompt phase; demonstrated that multi-TeV γ rays from intergalactic cascades are limited during early afterglow due to magnetic field constraints.

Conclusion: The downturn in the intrinsic γ-ray spectrum of GRB 221009A is explained by neutron-induced secondary emission from photohadronic interactions within the fireball, while contributions from intergalactic cascades at multi-TeV energies are suppressed by magnetic fields. This highlights the importance of secondary particle processes in shaping the high-energy emission of GRBs.
...
### [11] [Probing the Origin of Magnetar X-ray Polarization Diversity: A Multi-wavelength Geometrical Study of 1E 1547.0-5408 and 1E 2259+586](https://arxiv.org/abs/2604.10477)
*Biao-Peng Li,Zhi-Fu Gao,Wen-Qi Ma,Wei-Feng Zhang*

Main category: astro-ph.HE

TL;DR: This study analyzes the differing X-ray polarization levels in two magnetars, concluding that viewing geometry combined with intrinsic and magnetospheric physics explains the observed polarization dichotomy, without requiring strong global magnetic twists.


<details>
  <summary>Details</summary>
Motivation: The motivation is to understand whether the observed differences in X-ray polarization degrees among magnetars are primarily due to differences in viewing geometry rather than intrinsic physical processes.

Method: The paper uses a systematic comparative geometrical analysis of two magnetars with contrasting polarization properties within a Bayesian framework, modeling data using the classical rotating vector model (CRVM) and a twisted-magnetosphere extension (MRVM). It incorporates phase-resolved and phase-averaged data and radio-informed priors.

Result: The study finds that the high and low polarization in two magnetars can be explained without invoking strong, static global twists in the magnetosphere. The observed polarization differences arise from a combination of viewing geometry, intrinsic surface emission, and magnetospheric effects. No significant secular evolution in twist parameter was observed in 1E 2259+586.

Conclusion: The polarization diversity seen in magnetars is primarily governed by the interplay of viewing geometry, intrinsic emission physics, and magnetospheric propagation effects, rather than by strong, persistent magnetic twists.
...
### [12] [Searching for Gamma Ray Bursts associated with CHIME Fast Radio bursts](https://arxiv.org/abs/2604.10629)
*Yi-Fang Liang,Ye Li,Bao Wang,Xuan Yang,Yuan-Pei Yang,Xue-Feng Wu*

Main category: astro-ph.HE

TL;DR: This paper systematically searches for spatial and temporal links between FRBs and GRBs and finds no statistically significant associations, suggesting current data does not support a direct connection, highlighting the need for better localization and larger samples.


<details>
  <summary>Details</summary>
Motivation: To investigate the possible physical connection between fast radio bursts (FRBs) and gamma-ray bursts (GRBs), which are both linked to compact-object activity but whose relationship remains unclear.

Method: Systematic search for spatial and temporal associations between FRBs from the CHIME/FRB catalog and Swift GRBs using full CHIME localization probability maps for spatial cross-matching, redshift consistency filtering, temporal ordering criteria, and Monte Carlo simulations to assess statistical significance.

Result: The analysis identified 130 candidate spatial pairs, refined to 45 after redshift consistency checks and to 26 after temporal criteria. Monte Carlo simulations indicate these associations are consistent with chance. The results limit the possibility of a significant FRB-GRB connection and emphasize the impact of localization uncertainties and chance coincidences.

Conclusion: The study finds no statistically significant excess of spatial and temporal associations between FRBs and GRBs, suggesting that any physical connection is constrained by current localization and sample size limitations.
...
### [13] [A Turbulence-Driven Magnetic Reconnection Model for the High-Energy Neutrino Emission from NGC 1068](https://arxiv.org/abs/2604.10847)
*Luana Passos-Reis,Elisabete M. de Gouveia Dal Pino,Juan C. Rodríguez-Ramírez,Giovani H. Vicentin*

Main category: astro-ph.HE

TL;DR: The paper models NGC 1068's high-energy emission by magnetic reconnection-driven proton acceleration in the accretion disk corona, explaining the observed neutrino excess and gamma-ray attenuation via efficient hadronic interactions and photon fields, supporting turbulence-induced reconnection as a key mechanism for neutrino production in AGNs.


<details>
  <summary>Details</summary>
Motivation: The paper aims to explain the observed high-energy emission and neutrino flux excess in the Seyfert II AGN NGC 1068, which shows an anomalously high neutrino flux compared to gamma-ray emissions and no detected TeV gamma-ray counterpart, indicating efficient hadronic processes and strong gamma-ray absorption; this motivates the exploration of magnetic reconnection as a particle acceleration mechanism.

Method: The authors model proton acceleration within a turbulent magnetic reconnection layer using a first-order Fermi process in a lepto-hadronic framework based on a coronal-accretion disk configuration surrounding a $2 \times 10^{7} M_{\odot}$ black hole; they calculate particle acceleration and resultant emission by assuming magnetic reconnection between the black hole magnetosphere and inner accretion disk corona and evaluate neutrino and gamma-ray production via interactions with disk photons, X-rays, and protons.

Result: The model successfully reproduces the observed spectral energy distribution of NGC 1068 with a coronal magnetic field strength of about $10^{4}$ G and reconnection power of $\sim 10^{43}$ erg s$^{-1}$, achieving about 50% proton acceleration efficiency; protons reach energies around $10^{14}$ eV and primarily produce neutrinos through $pp$ interactions consistent with IceCube observations, while associated gamma-rays are strongly attenuated by $\gamma\gamma$ annihilation, explaining their non-detection.

Conclusion: Turbulence-induced magnetic reconnection within the accretion disk corona provides an efficient mechanism for accelerating protons to energies sufficient for neutrino production in NGC 1068, accounting for observed neutrino fluxes and gamma-ray attenuation, thus presenting a viable explanation for high-energy emissions in Seyfert II AGNs.
...
### [14] [A Comparative Study of TeV Gamma-Ray Sources with Various Objects](https://arxiv.org/abs/2604.11271)
*Xin Zhou,Ji Yang,Yang Su,Xuepeng Chen,Yang Chen,Yan Sun,Qing-Zeng Yan,Shaobo Zhang*

Main category: astro-ph.HE

TL;DR: This study uses a novel RAOC method to analyze the associations of LHAASO TeV gamma-ray sources with different astrophysical objects, finding significant links with SNRs, PWNe, and microquasars, highlighting the role of molecular clouds in gamma-ray production, while OB associations contribute little.


<details>
  <summary>Details</summary>
Motivation: To statistically assess the associations between LHAASO TeV gamma-ray sources and various astrophysical objects to clarify their contributions to TeV gamma-ray emission.

Method: A Randomization-Adjusted Overlap Correlation (RAOC) method was developed to estimate association probabilities and proportions between LHAASO gamma-ray sources and catalogs of different object types.

Result: Significant overlaps found between LHAASO sources and SNRs, PWNe, and microquasars, with respective association proportions of ~19%, 20%, and 2.7%. Approximately 60% of PWNe are gamma-ray bright, compared to 10% for SNRs and microquasars. Molecular clouds enhance PWN gamma-ray emission, evidenced by positional offsets. HII regions show complicated associations and OB associations likely have minimal contribution. Additionally, about 70% of gamma-ray components share a common origin, and selection effects are noted in SNR catalogs.

Conclusion: SNRs, PWNe, and microquasars are significant contributors to LHAASO TeV gamma-ray sources, with molecular clouds playing a role in enhancing PWN emissions. In contrast, OB associations contribute minimally, and complex factors affect associations with HII regions. The RAOC method effectively quantifies these relationships and reveals common origins among gamma-ray components.
...
### [15] [GeV gamma-ray emission in the field of the shell-type supernova remnant Vela Jr revisited](https://arxiv.org/abs/2604.11293)
...
### [16] [A Ring of Fire Orphan γ-Ray Flare in the Neutrino Candidate 3C 120](https://arxiv.org/abs/2604.11310)
*E. Traianou,G. Bruni,J. Rodi,G. F. Paraschos,S. G. Jorstad,A. P. Marscher,A. Lähteenmäki,M. Tornikoski,J. Tammi,I. Agudo*

Main category: astro-ph.HE

TL;DR: VLBI and multi-wavelength observations of 3C 120's orphan γ-ray flare reveal that a moving jet disturbance interacting with a stationary jet feature produces localized magnetic field compression and extreme γ-ray emission via inverse-Compton scattering, establishing a direct link between jet dynamics and orphan γ-ray flares.


<details>
  <summary>Details</summary>
Motivation: To investigate the physical origin of an orphan γ-ray flare in the radio galaxy 3C 120 during its brightest γ-ray outburst and its potential link to jet dynamics and neutrino emission.

Method: High-frequency (43 GHz) VLBI observations combined with contemporaneous multi-wavelength monitoring (X-ray, optical, and radio) were used to track jet disturbances and their interaction with stationary features in the jet during the γ-ray flare.

Result: The γ-ray flare coincided with a new jet disturbance (N) crossing a quasi-stationary jet feature (C3), accompanied by increased polarization and EVPA rotation, indicating magnetic field compression. The γ-ray luminosity was explained by inverse-Compton scattering of synchrotron photons from C3 by the moving disturbance, consistent with the Ring of Fire scenario. This mechanism differs from previous orphan flares near the BLR, indicating jet interaction at larger distances (~10 times the BLR radius).

Conclusion: This study provides the first direct observational evidence linking VLBI-resolved jet dynamics with orphan γ-ray emission in a radio galaxy, demonstrating a distinct physical mechanism involving a propagating jet disturbance interacting with stationary jet structure far beyond the BLR.
...
### [17] [A Falsifiable Timing Test for the Double-White-Dwarf Model of Long-Period Transients](https://arxiv.org/abs/2604.11317)
*Yejing Zhan,Di Wang,Fa-Yin Wang*

Main category: astro-ph.HE

TL;DR: The paper proposes that the long-period transient source CHIME/ILT J1634+44 is an ultra-compact double-white-dwarf binary, predicting measurable timing drifts in burst and modulation periods due to gravitational-wave and tidal effects, which can be tested observationally.


<details>
  <summary>Details</summary>
Motivation: To investigate the physical origin and timing behavior of the newly identified long-period transient radio source CHIME/ILT J1634+44, which shows unusual periodicities suggesting a binary system.

Method: The study models the observed short burst period and long-period modulation of CHIME/ILT J1634+44 under the assumption of a double-white-dwarf binary system, applying constraints from Roche-lobe geometry and considering effects of gravitational-wave emission, magnetic dissipation, and tidal interaction on period evolution.

Result: The modeling predicts that the modulation period (spin-orbit beat) must evolve together with the orbital period due to energy loss mechanisms, with a specific drift rate of approximately 10^{-10} s/s. This leads to a measurable timing drift of tens of seconds over one year, providing a testable prediction for the ultra-compact binary origin hypothesis.

Conclusion: The WD--WD binary interpretation imposes strict timing evolution constraints on the observed burst and modulation periods, creating a minimal and falsifiable test for the ultra-compact binary nature of CHIME/ILT J1634+44 via joint measurements of period changes.
...
### [18] [Galactic Diffuse Gamma-Ray and Neutrino Emission from Cosmic-Ray Interactions in Stellar Atmospheres](https://arxiv.org/abs/2604.11617)
*Yanbo Wang,Zhenglong Wang,Rui Zhang,Yi Zhang*

Main category: astro-ph.HE

TL;DR: This paper quantifies the diffuse gamma-ray and neutrino emission from Galactic stellar atmospheres, finding it negligible at 1 TeV and sub-dominant even at ultra-high energies, thus not impacting current searches for Galactic PeVatrons or dark matter signals.


<details>
  <summary>Details</summary>
Motivation: To explore the previously unquantified contribution of stellar atmospheres as hadronic interaction targets to the Galactic diffuse gamma-ray and neutrino backgrounds, which could affect multi-messenger astrophysical observations.

Method: The study combines MESA stellar evolution profiles with magnetic-field-modulated cosmic-ray transport within a 3D Galactic population synthesis framework to systematically evaluate the stellar diffuse emission component.

Result: The stellar diffuse gamma-ray flux is negligible at 1 TeV, with associated neutrino flux far below IceCube detection limits, but at energies above 10 TeV, this emission forms an irreducible local background that surpasses the extragalactic isotropic gamma-ray background. However, overall the stellar contribution remains sub-dominant and does not require subtraction in current analyses.

Conclusion: The cumulative gamma-ray and neutrino emission from stellar atmospheres in the Galaxy is sub-dominant and negligible compared to other backgrounds at energies around 1 TeV, and does not affect current observational constraints or source identification.
...
### [19] [Combining the Mass--Radius Posteriors of J0030+0451 Allowing for Unknown Model Systematics](https://arxiv.org/abs/2604.11621)
*Ryan O'Connor,Chun Huang,Alexander Y. Chen*

Main category: astro-ph.HE

TL;DR: This study combines eight discrepant mass-radius posteriors of pulsar PSR J0030+0451 using a Bayesian method that accounts for model uncertainties, producing a robust mass-radius measurement. Integrating this into joint analyses improves neutron star matter constraints relevant for the equation of state.


<details>
  <summary>Details</summary>
Motivation: Different hotspot modeling choices in pulse profile modeling of PSR J0030+0451 have led to inconsistent and divergent mass-radius posteriors, creating a bottleneck for reliable neutron star EoS inference. A method to combine these results while accounting for model uncertainties is needed.

Method: A robust Bayesian combination framework is employed to integrate eight published M-R posteriors of PSR J0030+0451, explicitly allowing for unknown systematic uncertainties caused by different hotspot model assumptions. The resulting posterior is then incorporated into a joint EoS-agnostic analysis with data from other neutron star observations (PSR J0437–4715 and GW170817).

Result: The Bayesian combination yields a reliable and conservative constraint on PSR J0030+0451's mass, radius, and compactness (M = 1.46^{+0.09}_{-0.08} M_⊙, R = 12.69^{+0.64}_{-0.55} km, C = 0.172^{+0.006}_{-0.007}), with 68% credibility. Incorporating this into a broader joint EoS analysis provides neutron star radius and tidal deformability constraints for a 1.4 solar mass star: R_{1.4} = 11.98^{+0.58}_{-0.68} km and Λ_{1.4} = 320^{+216}_{-138}.

Conclusion: The paper provides a consolidated and robust mass-radius (M-R) constraint for the pulsar PSR J0030+0451 by combining multiple previously published M-R posteriors that employed varying hotspot models, addressing model-dependent systematic uncertainties. This combined constraint improves the reliability of neutron star interior studies and enables more accurate dense matter equation-of-state (EoS) inference.
...
### [20] [A bright flare in the obscured state of GRS 1915+105 as seen by NICER and Swift](https://arxiv.org/abs/2604.11710)
*Shuaitongze Zhao,Honghui Liu,Menglei Zhou,Swarnim Shashank,Cosimo Bambi,Andrea Santangelo*

Main category: astro-ph.HE

TL;DR: Time-resolved X-ray spectroscopy during a bright flare in GRS 1915+105 reveals enhanced emission, evolving absorption features, and a complex geometry of absorbers and reflectors, indicating re-illumination after a failed disk wind and connected jet activity.


<details>
  <summary>Details</summary>
Motivation: To investigate the nature of a bright flare from the black hole X-ray binary GRS 1915+105 during its obscured state characterized by complex absorption geometry.

Method: Time-resolved X-ray spectroscopy with NICER and Swift, coupled with spectral modeling of Fe K emission features and absorption components.

Result: Detection of a flare with nearly tenfold increase in X-ray flux, showing evolving Fe K emission and distinct absorption in neutral and ionized reflection components, indicating a stratified absorber-reflector geometry and a re-illumination phase after a failed disk wind. A delayed radio flare suggests jet and accretion coupling.

Conclusion: The flare from GRS 1915+105 arises from enhanced intrinsic emission and reduced obscuration, with complex absorber-reflector geometry supporting a re-illumination linked to failed disk wind, and subsequent jet activity.
...
### [21] [The nature of tilted supercritical accretion discs](https://arxiv.org/abs/2604.11794)
*P. Chris Fragile,Matthew J. Middleton,Brooks Brasseur,Deepika A. Bollimpalli,Zach Smith*

Main category: astro-ph.HE

TL;DR: 3D simulations show that tilted supercritical accretion discs around black holes have up to 10x higher accretion rates than untilted ones, driven by tilt angle, spin, and unique inner shocks, which may explain early supermassive black hole growth.


<details>
  <summary>Details</summary>
Motivation: Investigate the dynamics and accretion rates of tilted supercritical accretion discs around black holes to understand their growth, especially for early supermassive black holes.

Method: Performed the first 3D general relativistic radiation magnetohydrodynamic simulations varying black hole spin (a* from -0.9 to 0.9), initial tilt (0° to 30°), and mass accretion rates.

Result: Tilted discs exhibit mass accretion rates enhanced up to tenfold compared to untilted discs, proportional linearly to tilt angle and black hole spin magnitude. Tilted discs are also more advective and feature standing shocks in the inner region, unlike untilted discs.

Conclusion: The enhancement in mass accretion due to tilt and spin and the presence of shocks in tilted supercritical accretion discs can explain the rapid growth of early supermassive black holes, highlighting the importance of tilt in accretion physics.
...
### [22] [Inflationary magnetogenesis from non-minimal coupling in large- and small-field potentials](https://arxiv.org/abs/2604.10143)
*Orlando Luongo,Antonino Giacomo Marino,Tommaso Mengoni*

Main category: astro-ph.CO

TL;DR: This work shows that breaking electromagnetic conformal invariance via non-minimal inflaton-Ricci scalar coupling enhances primordial magnetic fields significantly in large-field inflation, compatible with observations, while small-field inflation fails to generate observable fields in this setup.


<details>
  <summary>Details</summary>
Motivation: To study inflationary magnetogenesis by breaking conformal invariance in electromagnetism via a non-minimal Yukawa-like coupling between the inflaton and the Ricci scalar, addressing electromagnetic backreaction and the Schwinger effect in different inflation models.

Method: Analyzed electromagnetic backreaction and Schwinger effect in standard single-field and generalized K-essence (quasi-quintessence) inflationary frameworks, considering Planck-compatible potentials (Starobinsky, α-attractors, hilltop), and introduced novel electromagnetic coupling ansatz for small-field models.

Result: Non-minimal coupling acts as a timing parameter controlling onset of electric backreaction and Schwinger regimes, significantly modifying magnetogenesis. Large-field models yield amplified magnetic fields up to ~10^{-13} G, compatible with observations, while small-field models produce negligible magnetic fields and lack predictivity in this framework.

Conclusion: The non-minimal Yukawa-like coupling between inflaton and Ricci scalar critically regulates magnetogenesis during inflation, enhancing magnetic field amplitudes in large-field inflationary scenarios consistent with observational constraints, whereas small-field models are ineffective under this mechanism.
...
### [23] [An Analytic Formalism of Inflation for Derivative Coupled Scalar Field and Validating its predictions for Some Inflationary Potentials](https://arxiv.org/abs/2604.10148)
...
### [24] [Low-ionization Metal Absorption at $0.7 \lesssim z \lesssim 2$ Confronting Cosmological Simulations with Observations](https://arxiv.org/abs/2604.10595)
...
### [25] [Reionization Topology as a Probe of Self-Interacting Dark Matter](https://arxiv.org/abs/2604.10726)
*Zihan Wang*
...
### [26] [On the origin of the BAOtr-DESI tension](https://arxiv.org/abs/2604.11106)
*Ioannis Pantos,Leandros Perivolaropoulos*

Main category: astro-ph.CO

TL;DR: This paper analyzes the tension between two BAO datasets, showing that this discrepancy cannot be reconciled by current CPL dark energy models or fiducial assumptions. The conflict suggests either observational systematics or physics beyond the CPL framework.


<details>
  <summary>Details</summary>
Motivation: To investigate the cause of the disagreement between the fiducial-independent transversal BAO dataset (BAOtr) and the DESI DR2 three-dimensional BAO measurements at redshifts below ~0.65, which leads to conflicting dark energy inferences and discrepancies related to the Hubble tension.

Method: The study examines whether the discrepancy arises from the ΛCDM fiducial model assumed in the 3D BAO pipeline or can be resolved within the CPL dark energy parametrisation. It involves scanning the CPL parameter space with joint determination of Ω_m and H_0 at each (w_0, w_a) point using Planck θ_* constraints and optimises against DESI data. Two tests are performed: direct comparison of DESI-optimized models with BAOtr data and an α-interpolation test anchored on DESI measurements.

Result: The analysis shows that 3D BAO distances are fiducial-independent with negligible residual effects. A trade-off exists where models that fit DESI well poorly fit BAOtr and vice versa, with no CPL model consistent with CMB data fitting both datasets simultaneously. The irreducible tension at z = 0.510, where the datasets differ by 3.7σ, cannot be resolved by smooth modifications of the comoving distance function D_M(z). The findings are robust across methods and dataset substitutions.

Conclusion: The tension between BAOtr and DESI datasets is intrinsic and cannot be resolved within the CPL parametrisation under current assumptions. Potential explanations include observational systematics, especially in angular BAO measurements, or the need for new physics beyond the CPL model.
...
### [27] [First observational constraints on cosmic backreaction over an extended redshift range](https://arxiv.org/abs/2604.11249)
*S. M. Koksbang*
...
### [28] [Emergence of Complex Structures](https://arxiv.org/abs/2604.11481)
*Francisco-Shu Kitaura*

Main category: astro-ph.CO

TL;DR: A unified mesoscopic framework combining phase-space dynamics, transport geometry, and information theory explains how complex structures emerge with increasing entropy by showing ordered behavior in coarse-grained fields and revealing the roles of anisotropy, nonlocality, and nonlinear transport; applied mainly to cosmology but broadly relevant to self-organizing systems.


<details>
  <summary>Details</summary>
Motivation: To resolve the apparent contradiction between the emergence of order in complex structures and the second law of thermodynamics stating entropy growth, by constructing a unified, mesoscopic framework that captures transport-induced anisotropies, nonlocality, and self-organization effects in evolving systems.

Method: Combining semi-microscopic phase-space dynamics, transport geometry, information theory, and coarse-grained effective modeling; employing a Lagrangian--Eulerian transport map to analyze density amplification via Jacobian deformation; linking geometric descriptions to maximum-entropy Gaussian baselines; formulating a Landau--Ginzburg approach to model anisotropy growth as activation of free-energy branches.

Result: The framework elucidates how coarse-grained fields can become more ordered while overall phase-space complexity increases, identifies the role of anisotropic collapse and nonlocal transport encoded in displacement fields, and demonstrates the relevance of nonlocal tidal interactions at moderate overdensity in cosmological contexts, extending the framework's applicability to a broad class of transport-driven self-organizing systems.

Conclusion: The framework unifies phase-space dynamics, transport geometry, and information theory to reconcile entropy growth with the emergence of complex structures, demonstrating that ordering can increase at coarse-grained levels despite increasing complexity in full phase-space. It reveals the significance of nonlocal tidal effects and nonlinear transport in structure formation and self-organization, providing a mesoscopic model applicable beyond cosmology.
...
### [29] [Impact of Stochastic Pop~III X-ray Binaries on the Cosmological 21-cm Signal](https://arxiv.org/abs/2604.11542)
*Saswata Dasgupta,Boyuan Liu,Anastasia Fialkov,Furen Deng,Jiten Dhandha,Rennan Barkana*

Main category: astro-ph.CO

TL;DR: This paper introduces a stochastic model for X-ray luminosity in high-mass X-ray binaries, showing enhanced small-scale fluctuations in 21-cm signals during Cosmic Dawn, important for accurate simulations but likely undetectable by near-future instruments.


<details>
  <summary>Details</summary>
Motivation: Traditional simulations use a deterministic relation between X-ray luminosity and star formation rate in high-mass X-ray binaries, which is inaccurate for low-SFR, high-redshift regions with few sources, leading to underestimated fluctuations in the 21-cm signal from Cosmic Dawn.

Method: A stochastic model for X-ray luminosity was introduced, sampled from a power-law X-ray luminosity function, and implemented within the 21cmSPACE large-scale simulation framework to study fluctuations in X-ray heating and their effects on the 21-cm power spectrum.

Result: Stochasticity enhances fluctuations in X-ray heating on small scales (k>0.3 cMpc^{-1}) but has negligible impact on the global 21-cm signal and large-scale power spectrum. The effects are predicted to be undetectable by the Square Kilometer Array but potentially observable by future large-scale lunar-based experiments at z~25.

Conclusion: Incorporating stochastic variations in X-ray luminosity from high-mass X-ray binaries is essential for accurate modeling of 21-cm signals during Cosmic Dawn, reducing astrophysical biases in precision data interpretation, though current observatories may not detect these small-scale fluctuations.
...
### [30] [Cosmological inference with halo clustering reconstructed from the redshift-space galaxy distribution](https://arxiv.org/abs/2604.11694)
*Ryuichiro Hada,Teppei Okumura*

Main category: astro-ph.CO

TL;DR: This paper demonstrates that halo reconstruction via cylinder grouping combined with EFT modeling improves small-scale RSD analyses, yielding unbiased and more precise cosmological constraints, with over 20% improvement in growth rate measurement precision.


<details>
  <summary>Details</summary>
Motivation: Accurately modeling small-scale redshift-space clustering is key for robust full shape redshift-space distortion (RSD) analyses, particularly due to complex effects from satellite galaxies and Finger-of-God distortions.

Method: They use the cylinder grouping (CG) method to reconstruct halo centers from galaxy distributions in DESI-like LRG mock catalogs at redshift 1.1, then apply effective field theory (EFT)-based full-shape modeling of the power spectrum of the reconstructed halo sample.

Result: The main systematics from reconstruction can be modeled within the standard EFT framework with a multipole-dependent rescaling on large scales and standard counterterms absorbing residuals without extra parameters. The reconstructed halo sample provides unbiased cosmological constraints, improves robustness, and increases precision, notably a more than 20% reduction in uncertainty of the growth rate $fσ_8$, stable beyond $k_{max} \approx 0.2\,h\,{\rm Mpc}^{-1}$.

Conclusion: Cylinder grouping-based halo reconstruction enables unbiased and more precise cosmological parameter inference from RSD full-shape analyses by effectively capturing dominant systematics within the EFT framework, enhancing both robustness and statistical power.
