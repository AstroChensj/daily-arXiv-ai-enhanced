...
### [12] [Smoking-gun evidence for hierarchical black-hole mergers](https://arxiv.org/abs/2607.01121)
...
### [13] [Heavy element dust explains the late-time spectra of kilonovae](https://arxiv.org/abs/2607.00433)
...
### [14] [Mapping the Dense Circumstellar Environments of SNe Ibn, SNe Icn, and Fast Blue Optical Transients](https://arxiv.org/abs/2607.00453)
...
### [15] [FRB20250613A: a remarkable repeating FRB with apparent millisecond-timescale scattering variations](https://arxiv.org/abs/2607.00505)
...
### [16] [Distinct spin properties and astrophysical origin of low mass binary black holes in gravitational wave data](https://arxiv.org/abs/2607.00565)
...
### [17] [A self-consistent single-fluid framework for neutron stars admixed with mirror dark matter](https://arxiv.org/abs/2607.00888)
...
### [18] [Bridging the gap between SLSNe and SE-SNe. Multi-wavelength analysis of the SLSN-Ib SN 2024jlc](https://arxiv.org/abs/2607.01053)
...
### [19] [First Gamma-Ray Burst Observations with SVOM](https://arxiv.org/abs/2607.01090)
...
TL;DR: This paper studies the saturation of magneto-thermal instability in adiabatic galaxy cluster outskirts, using simulations and modeling, revealing that large plumes created by MTI can drive strong turbulence and pressure support even with limited thermal conduction.


<details>
  <summary>Details</summary>
Motivation: Observations show flatter radial entropy profiles near galaxy cluster peripheries than predicted, prompting investigation of MTI saturation in adiabatic atmospheres.

Method: Used phenomenological modeling and Boussinesq numerical simulations with the pseudospectral code SNOOPY to study MTI saturation.

Result: Found that MTI saturates via large-scale plume formation destroyed by shear instability, leading to a new scaling law for turbulent kinetic energy proportional to effective thermal diffusivity and MTI frequency.

Conclusion: MTI in adiabatic cluster outskirts can produce near sonic plumes, providing substantial turbulent pressure support despite suppressed thermal conduction.
...
TL;DR: XRISM Resolve observations reveal that the intracluster medium in A496’s core has very low turbulent and bulk velocities, confirming it as a dynamically quiescent, strong cool-core cluster with minimal AGN-driven disturbance.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamical history and physical processes within the galaxy cluster A496 by investigating the gas motions in its intracluster medium (ICM).

Method: High-resolution X-ray spectroscopy using the Resolve micro-calorimeter on board XRISM was employed to measure line-of-sight (LOS) bulk and turbulent velocities in the core of A496. Optical redshift analysis and comparisons with simulations and multiwavelength observations were also conducted.

Result: The core of A496 is dynamically quiescent with a LOS bulk velocity of -69^{+25}_{-20} km/s relative to the Brightest Cluster Galaxy (BCG) and a turbulent velocity of 78^{+18}_{-16} km/s, the lowest measured to date by Resolve in cluster cores. The turbulent velocity corresponds to a subsonic Mach number of 0.15 and a non-thermal pressure fraction of about 1.2%. AGN feedback contributes roughly 7-9% to ICM heating, and simulations corroborate the small AGN impact and measured velocities. A496 is among the most quiescent sloshing cluster cores observed.

Conclusion: The ICM in the core of A496 exhibits remarkably low turbulence and bulk motions, indicating a dynamically relaxed cool-core cluster with minimal AGN feedback influence. This supports the view that A496 may be one of the most quiescent sloshing cluster cores known, with turbulence levels consistent between observations and simulations.
...
TL;DR: REACH models the radio sky to separate the faint 21cm hydrogen signal from brighter foregrounds using progressively complex models. It effectively recovers synchrotron emission but struggles with free-free emission. This approach produces calibrated low-frequency sky maps and supports both cosmological studies and Galactic physics exploration.


<details>
  <summary>Details</summary>
Motivation: The paper aims to detect the hydrogen 21cm signal by effectively separating it from much brighter foreground radio emissions, a challenging task critical for advancing radio cosmology.

Method: REACH forward-models the radio sky by jointly fitting signal and foreground spectral parameters to existing sky maps, employing physically motivated foreground models of increasing complexity and evaluating these against simulated observations based on established sky models.

Result: The study finds that more complex foreground models are necessary to accurately recover the 21cm signal in complex datasets, though this introduces parameter degeneracies limiting foreground accuracy. Synchrotron emission is well recovered across the sky, while free-free emission recovery is limited. REACH can map the radio sky at very low frequencies and probe Galactic physics beyond its primary cosmological goals.

Conclusion: REACH's forward-modeling approach enables spectral separation of the 21cm signal from complex foregrounds, achieving absolutely calibrated low-frequency sky maps and revealing its potential to study Galactic components alongside cosmological signals, despite challenges due to model degeneracies.
...
TL;DR: Soliton cores in fuzzy dark matter can enhance black hole accretion rates temporarily, but only intermediate-mass black holes maintain durable boosts; overall, soliton-driven accretion alone likely cannot explain rapid early supermassive black hole growth.


<details>
  <summary>Details</summary>
Motivation: To investigate whether soliton cores in fuzzy dark matter can significantly boost black hole accretion rates to facilitate rapid black hole growth at high redshift.

Method: Simulations of live Schrodinger-Poisson FDM cores coupled with isothermal gas, evolving a moving black hole that grows via a mass-conserving sink, measuring accretion rate boosts relative to the initial Bondi rate.

Result: Low-mass black holes do not sustain large accretion boosts due to black hole wandering and soliton sloshing causing intermittent dense gas presence; intermediate-mass seeds achieve the most durable accretion boosts (~100x) under certain gas conditions; high-mass seeds quickly become supply-limited despite deepened potentials; overall, central potential deepening alone does not guarantee sustained accretion enhancements.

Conclusion: Soliton-enhanced accretion in fuzzy dark matter halos alone is insufficient for early supermassive black hole growth, as sustained accretion requires dynamic confinement of the black hole within the dense nuclear gas region.
