...
TL;DR: This study shows that skewness in likelihood has minimal impact on cosmological parameter inference with Euclid-like data; Gaussian likelihood assumptions are confirmed robust using Edgeworth expansion and extensive mock catalogs.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the issue of skewness in parameter inference and its impact on cosmological constraints, aiming to improve likelihood modeling beyond the Gaussian assumption.

Method: They model the likelihood using an Edgeworth expansion incorporating the full skewness tensor (1-point, 2-point, 3-point correlators). A change of basis simplifies the precision matrix and skewness tensor computations, focusing on diagonal terms.

Result: Including only the diagonal skewness terms suffices; full skewness tensor inclusion adds noise without accuracy gains. Cosmological constraints remain nearly unchanged compared to Gaussian likelihood, with less than 5% variation in figure of merit across different settings and statistics. No detectable skewness appears on intermediate scales in realistic Euclid mocks due to shot noise.

Conclusion: The Gaussian likelihood assumption is robust for Euclid 2-point statistics analyses in both Fourier and configuration spaces, even considering skewness via Edgeworth expansion.
...
TL;DR: This paper models the merger-driven growth of primordial black holes in clusters to explain high-redshift supermassive black holes detected by JWST, using coagulation equations and Monte Carlo simulations to track their mass evolution over time.


<details>
  <summary>Details</summary>
Motivation: To explain the high-redshift supermassive black holes observed by JWST through primordial black hole clustering.

Method: Simulation of primordial black hole mergers using the Smoluchowski coagulation equation, deriving coagulation kernels with and without mass segregation effects, and solving via Monte Carlo with full-conditioning and discrete inverse transformation.

Result: Determination of runaway merger timescales and mass evolution of primordial black holes in clusters across cosmic redshifts, contingent on cluster size and density.

Conclusion: Primordial black hole clustering and successive mergers can account for the early formation of supermassive black holes observed as "little red dots" by JWST.
...
TL;DR: This paper analyzes the impact of the Generalized Uncertainty Principle on cosmology by modifying ΛCDM dynamics and constraining the related deformation parameter β using multiple datasets, finding indications of minimal length effects and some observational preference for the modified model.


<details>
  <summary>Details</summary>
Motivation: To explore the cosmological implications of the Generalized Uncertainty Principle (GUP), particularly how a minimal length affects late-time universe structure and dark energy dynamics.

Method: Used redshift-space distortion measurements combined with background cosmological data (cosmic chronometers, BAO, Type Ia supernovae) to constrain the deformation parameter β in a modified ΛCDM model incorporating a modified Poisson bracket and Raychaudhuri equation reflecting GUP effects.

Result: Constraints indicate a systematically negative deformation parameter β with the ΛCDM limit within the 95% credible interval. Model comparisons show weak-to-strong support for the GUP-modified model when supernova data are included, with Bayesian evidence favoring it weakly.

Conclusion: The study reveals measurable imprints of the Generalized Uncertainty Principle on cosmological scales, suggesting that minimal length effects can influence late-time universe dynamics and dark energy behavior, with observational data providing tentative support for this extension of the ΛCDM model.
...
TL;DR: This study models binary star systems with traversable wormholes to identify observational signatures that differentiate them from black holes or triple systems, finding that radial velocity perturbations are detectable with upcoming instruments using advanced data analysis techniques over realistic timescales.


<details>
  <summary>Details</summary>
Motivation: To investigate observational signatures of traversable wormholes by analyzing their influence on binary star systems, enabling distinction from black holes and triple systems.

Method: Modeling binary systems with a traversable wormhole candidate and companion star; analyzing perturbation in companion star's motion and radial velocity; comparing with stochastic stellar influences and models of BH binaries and triple systems; applying spectral and non-parametric data analysis methods to simulated radial velocity data over time.

Result: Radial velocity perturbations caused by a wormhole are detectable with near-future observational accuracy (1.5 km/s) over practical timescales; at 10 km/s accuracy, significant detection requires about 17 years of data, which can be shortened using spectral and non-parametric methods versus matched-filtering alone.

Conclusion: Observational manifestations of traversable wormholes in binary systems may be distinguished from black hole or triple system scenarios through detailed analysis of radial velocity perturbations, with spectral and non-parametric techniques enhancing detectability within feasible observation periods.
...
TL;DR: This study calibrates gamma-ray bursts using supernova data and Bézier interpolation to test dark energy evolution up to redshift 9. It finds a Hubble constant near 70 km/s/Mpc, lessening Hubble tension, disfavors spatial curvature, and finds no strong evidence for dynamical dark energy, supporting the cosmological constant model.


<details>
  <summary>Details</summary>
Motivation: To investigate the possible dynamical behavior of dark energy and verify or reject time-evolution of the dark energy equation of state, extending measurements to high redshifts using gamma-ray bursts as cosmological probes.

Method: Utilized the updated gamma-ray burst catalog calibrated with type Ia supernovae catalogs and Bézier interpolation of the Hubble rate to bypass limitations of cosmographic series, combined with a model-independent, redshift-binned dark energy parametrization and analysis of spatial curvature effects.

Result: The calibrated Combo correlation yields a Hubble constant around 70 km/s/Mpc, alleviating the Hubble tension; spatial curvature is disfavored; evolutionary signs of dark energy equation of state are not statistically significant beyond low redshift 'phantom' behavior; results support consistency with the cosmological constant scenario.

Conclusion: Gamma-ray bursts calibrated via the Combo correlation provide Hubble constant measurements that ease the Hubble tension and support a cosmological constant model of dark energy, showing no robust evidence for its dynamical evolution, and are consistent with the established cosmic distance ladder.
...
TL;DR: A new non-minimally coupled quintessence model explains the late-time weakening of dark energy observed by DESI, showing energy transfer sign changes with dark matter and outperforming standard ΛCDM models in data fitting.


<details>
  <summary>Details</summary>
Motivation: To address and explain the late-time dark energy dynamics and weakening observed in recent DESI measurements, which are not fully accounted for in standard cosmological models.

Method: Propose a novel non-minimally coupled quintessence model wherein quintessence density decreases only after dominance, inducing a sign change in energy transfer between dark matter and dark energy without crossing the phantom divide by the scalar field itself.

Result: The model naturally explains the late-time onset of dark energy weakening and exhibits an effective crossing behavior of dark energy when inferred observationally; it is favored over the ΛCDM and w₀wₐCDM models by current cosmological data.

Conclusion: The proposed non-minimally coupled quintessence model provides a robust theoretical framework for the observed late-time weakening of dark energy and offers insight into its dynamic origin, presenting a promising alternative to standard dark energy models.
...
TL;DR: This study analyzes gravitational wave fluctuations caused by strong and weak lensing using geometric optics and perturbation theory, deriving an amplification factor that respects known consistency relations and shows new effects on magnification and Fresnel scale shifts.


<details>
  <summary>Details</summary>
Motivation: To understand how gravitational waves are affected by combined strong and weak lensing, particularly the amplitude and phase fluctuations due to wave optics effects.

Method: Applying geometric optics approximation for the strong lens and perturbative treatment for cosmological weak lenses to derive the amplification factor to second order; additionally, introducing a diagrammatic method to systematically evaluate weak lensing effects.

Result: Derived amplification factor including second-order weak lensing effects; established consistency relations hold even with a strong lens; showed the mean weak lensing signal exhibits magnification and Fresnel scale shifts matching variance behavior.

Conclusion: The interplay between strong and weak lensing on gravitational waves can be systematically described, preserving known consistency relations and revealing coherent physical effects including magnification and Fresnel scale shifts in the weak lensing statistics.
...
TL;DR: This paper leverages a novel topological data analysis technique, persistence strips, applied to cosmological simulations to improve constraints on neutrino mass, overcoming traditional degeneracies and highlighting the promising role of topology in cosmic structure studies.


<details>
  <summary>Details</summary>
Motivation: Traditional cosmological probes of neutrino mass face challenges due to parameter degeneracies, limiting their effectiveness in constraining neutrino mass and understanding its impact on cosmic structure.

Method: The paper introduces persistence strips, a topological summary technique that segments Betti curves by topological persistence, converting 2D persistence diagrams into 1D curves. These are applied to the FLAMINGO cosmological simulations and used to build an emulator over a 10-dimensional cosmological parameter space including neutrino mass and degenerate parameters.

Result: Persistence strips yield significantly improved sensitivity to neutrino mass, achieving uncertainties of 0.05 eV for total matter and 0.13 eV for dark matter-only fields. They outperform unbinned Betti curves by roughly a factor of two and break degeneracies through multi-scale and environment-specific sensitivity. The strongest constraints come from void topology.

Conclusion: Topological statistics based on persistent homology, particularly persistence strips, provide a powerful new approach to constrain neutrino mass in cosmology. They effectively isolate signals from neutrino mass and associated effects, particularly in underdense regions, and are promising for application to weak lensing observations probing total matter distribution.
...
TL;DR: This paper finds evidence for a distinct population of black holes formed by failed supernovae, causing a peak at 10 solar masses and a gap between 12-16.1 solar masses in the merger rate distribution from gravitational-wave data.


<details>
  <summary>Details</summary>
Motivation: Gravitational-wave observations show a significant drop in merging black hole rates between ~10 and ~15 solar masses, which is not fully explained by progenitor core compactness.

Method: Analyzed 153 observations from the GWTC-4.0 catalog, considering a distinct subpopulation of failed-supernovae black holes and examining the primary mass distribution for evidence of a gap and overdensity around 10 solar masses.

Result: Confirmed a strong peak in the primary mass distribution at 10 solar masses with a high rate density, a sharp drop to near zero rate between 12-16.1 solar masses, then a rise again beyond ~16 solar masses, indicating a distinct failed-supernova black hole population.

Conclusion: The observed mass distribution structure between 10-20 solar masses, characterized by abrupt rate changes, supports the existence of a separate population of black holes formed via failed supernovae direct collapse, reinforcing the overdensity around 10 solar masses.
...
TL;DR: This study shows that during the O5 gravitational wave run, nearby GRBs' optical counterparts can be localized within small sky areas and detected with sufficiently deep optical observations (≥23 mag), shifting the primary challenge to achieving observational depth and correct transient identification rather than localization precision.


<details>
  <summary>Details</summary>
Motivation: To explore the challenge of identifying electromagnetic counterparts to gravitational wave sources, specifically nearby merger-induced GRBs, to enhance multimessenger astronomy investigations.

Method: Simulating localization of nearby GRBs by the LIGO-Virgo-KAGRA network during the fifth observing run (O5) and assessing optical counterpart detectability using observed GRB afterglow lightcurves and kilonova lightcurve templates.

Result: Nearby GRBs can be localized to small sky regions (few to tens of square degrees), and their optical counterparts are detectable by optical telescopes during O5 if sufficient observational depth (≥23 mag) is achieved.

Conclusion: The main difficulty in multimessenger discovery of nearby merger-induced GRBs during O5 lies in reaching adequate observational depth and accurately distinguishing true counterparts from unrelated transients, rather than the gravitational wave localization itself.
...
TL;DR: High-energy gamma-ray sources detected by Fermi-LAT tend to lie along lines of sight intersecting more cosmic voids than optical quasars, likely because weak magnetic fields in voids enhance gamma-ray flux during propagation rather than differences in their local environments.


<details>
  <summary>Details</summary>
Motivation: To investigate the impact of cosmic voids on the propagation of high-energy photons and to understand why active galactic nuclei (AGN) detected by Fermi-LAT lie along voidier sightlines than redshift-matched SDSS quasars.

Method: Analyzing the fraction of line of sight intersecting cosmic voids ('voidiness'), comparing voidiness distributions between gamma-ray detected AGN and SDSS quasars, and considering astrophysical mechanisms such as weaker intergalactic magnetic fields and line-of-sight interactions enhancing gamma-ray flux; also comparing with very-high-energy AGN data and simulating random distributions.

Result: The study finds that a small increase (~0.1% per Mpc) in gamma-ray flux due to line-of-sight interactions through voids can explain the higher voidiness of Fermi-LAT AGN compared to SDSS quasars. There is no significant local void effect on gamma-ray sources. The fraction of gamma-ray detected sources within voids matches random expectations, suggesting the voidiness difference arises from propagation effects rather than source environments.

Conclusion: The observed difference in voidiness between gamma-ray AGN and optically selected quasars is likely caused by line-of-sight interactions enhancing gamma-ray flux in voids, not by local void effects around gamma-ray sources.
...
TL;DR: This paper explains cosmic ray spectral hardening by Galactic outflows modeled phenomenologically, fitting AMS-02 data well and aligning with independent outflow observations, suggesting a viable alternative to diffusion-based interpretations.


<details>
  <summary>Details</summary>
Motivation: To explain the observed spectral hardening in Galactic cosmic ray fluxes without relying on microphysical variations in scattering properties.

Method: Using a phenomenological transport model incorporating macroscopic Galactic outflows (e.g., eROSITA bubbles) and fitting global precision AMS-02 data.

Result: The model naturally reproduces the 300 GV hardening in secondary-to-primary ratios and yields an effective local inner halo boundary of ~5 kpc and outflow speed of ~360 km/s, consistent with independent kinematic data.

Conclusion: Spectral hardening in Galactic cosmic ray fluxes can be attributed to large-scale advective Galactic outflows rather than changes in diffusion properties, providing a testable and parameter-economical alternative explanation.
...
TL;DR: This paper shows that intrinsic burst morphology contaminates modeled dispersion measures in fast radio bursts, but short-duration microshots and narrow bursts can reliably measure the real dispersion measure, revealing significant pseudo DM variations in repeating FRBs.


<details>
  <summary>Details</summary>
Motivation: To accurately determine the real dispersion measure (DM_real) of fast radio bursts (FRBs) by addressing contamination from intrinsic burst morphology in the modeled DM (DM_model), which introduces a pseudo DM component (DM_pseudo).

Method: Focused on repeating FRB 20220912A, utilized extremely short-duration microshots with negligible intrinsic time delay. Assumed a stable, non-magneto-ionic environment and minimal variation in DM_real over years. Identified and combined new microshots with existing ones to measure consistent DM values. Conducted a survey of five repeating FRBs to assess the prevalence of DM_pseudo.

Result: The average DM_real for FRB 20220912A was determined as 219.380 ± 0.004 pc cm^-3, consistent across microshots and narrow bursts under 2 ms. The study found that DM_pseudo commonly affects repeating FRBs, causing variations up to ~10 pc cm^-3. Microshots and narrow bursts serve as effective probes to distinguish DM_real from DM_pseudo.

Conclusion: Intrinsic burst morphology can significantly bias dispersion measure estimates in FRBs, leading to a pseudo DM component. Using microshots and narrow bursts allows robust measurement of the real DM, improving interpretation of FRB propagation effects. Accounting for DM_pseudo is crucial for accurate FRB studies.
...
TL;DR: This paper uses Gaussian process regression on X-ray data of Swift J1727.8-1613 to model variability via damped oscillators and random walks, revealing magnetic cavity dynamics, accretion flow viscosity, and disk changes preceding jet ejection, demonstrating GP's power in astrophysical timing analysis.


<details>
  <summary>Details</summary>
Motivation: To link X-ray variability with the underlying magnetohydrodynamic dynamics in black hole X-ray binaries, which is challenging due to complex physical processes.

Method: Used Gaussian process regression with a composite kernel combining a stochastically driven damped simple harmonic oscillator and two damped random walk components on multi-band light curves from Insight-HXMT.

Result: Recovered quasi-periodic oscillations consistent with Alfvén modes, observed increasing coherence in the magnetic cavity, found anti-correlation between QPO frequency and damping timescale, inferred viscosity parameter supporting strongly magnetized accretion flow, and observed rapid disk reorganization before jet ejection.

Conclusion: GP regression effectively connects X-ray timing variability with magnetohydrodynamic processes in black hole accretion flows, providing insights into disk dynamics and jet launching mechanisms.
...
TL;DR: A new FRB-associated X-ray burst (MXB 221120) from magnetar SGR J1935+2154 exhibits unique thermal spectral and temporal properties, suggesting an uncommon physical mechanism behind its production.


<details>
  <summary>Details</summary>
Motivation: To investigate the nature of FRB-associated magnetar X-ray bursts (MXBs) and increase the limited sample size of such events, enhancing understanding of their physical mechanisms.

Method: Detection and analysis of a bright FRB-associated MXB from SGR J1935+2154 using GECAM data, including temporal, spectral analysis, and identification of light curve features such as FRED function fitting and quasi-periodic oscillations (QPO).

Result: Identification of MXB 221120 with a unique thermal spectrum modeled by blackbody radiation at 18.6 keV, a longer duration, higher temperature, and a possible ~18 Hz QPO, indicating distinctive physical conditions compared to other MXBs.

Conclusion: MXB 221120 represents a peculiar FRB-associated magnetar X-ray burst produced by a special mechanism under extreme physical conditions, expanding the diversity of known FRB-associated MXBs and offering new insights into their origins.
...
TL;DR: This paper presents high-sensitivity MeerKAT polarimetric observations of three pulsar binaries, revealing detailed plasma propagation effects, frequency-dependent polarization changes, and magnetic field structures in their magneto-ionic environments.
...
Method: MeerKAT's high-sensitivity polarimetric observations were used to characterize polarization properties, dispersion measure, rotation measure, and scattering time of three pulsar binaries: PSR J1740-3052, PSR J2051-0827, and PSR J1748-2446A.

Result: Observed orbital-phase-dependent propagation effects, including eclipses in millisecond pulsars. PSR J1740-3052 showed smooth RM variations near periastron allowing constraints on small-scale magnetic structures. PSR J2051-0827 displayed frequency-dependent linear polarization profile changes. PSR J1748-2446A exhibited polarization propagation effects during eclipse ingress and egress, possibly due to Faraday Conversion or multipath propagation.

Conclusion: The study successfully characterized the magneto-ionic plasma environments around these pulsar binaries using detailed polarimetric observations, revealing small-scale magnetic structures and complex polarization propagation effects related to their orbital phases and companion winds.
